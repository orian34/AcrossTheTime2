...
execute if score Real0 TIMER matches 370 run data merge entity 00000000-0000-006b-0000-00000000006b {active_effects:[{id:invisibility,amplifier:1,duration:2147483647,ambient:1,show_particles:0b}]}
