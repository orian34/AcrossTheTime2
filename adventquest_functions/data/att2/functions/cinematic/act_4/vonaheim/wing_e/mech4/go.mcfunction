...
# Particle
execute if entity @a[x=-5500,y=80,z=-6400,distance=..40,gamemode=adventure] run particle minecraft:item minecraft:ice -5497 33 -6395 2 20 2 2.5 20 force
execute if entity @a[x=-5500,y=80,z=-6400,distance=..40,gamemode=adventure] run particle minecraft:cloud -5497 33 -6395 2 20 2 1.2 10 force
