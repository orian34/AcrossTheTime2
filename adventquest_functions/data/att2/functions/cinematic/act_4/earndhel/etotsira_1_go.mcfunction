...
execute if score Real0 TIMER matches 20 run function att2:voice/etotsira/etotsira48
...
execute if score Real0 TIMER matches 300 run function att2:voice/etotsira/etotsira49
...
execute if score Real0 TIMER matches 650 run function att2:voice/etotsira/etotsira50
...
execute if score Real0 TIMER matches 1000 run function att2:voice/etotsira/etotsira51
