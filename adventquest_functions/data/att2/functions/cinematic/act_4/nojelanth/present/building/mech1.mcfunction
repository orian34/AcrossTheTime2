...
execute positioned -5912 124 -4386 run function att2:summon/reg_1/undead4_class17
execute positioned -5907 116 -4390 run function att2:summon/reg_1/undead3_class18
