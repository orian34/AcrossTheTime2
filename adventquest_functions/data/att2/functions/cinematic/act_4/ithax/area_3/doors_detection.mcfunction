...
# Corridor
execute if score area3_yellow_door1 ITHAX matches 0 if entity @a[x=-7431,y=158,z=-5930,dx=2,dy=-2,dz=2,gamemode=adventure,nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§6Minor pass\"}"]}}}}] run function att2:cinematic/act_4/ithax/area_3/corridor/door_yellow_opening_1
execute if score area3_yellow_door1 ITHAX matches 1 unless entity @a[x=-7431,y=158,z=-5930,dx=2,dy=-2,dz=2,gamemode=adventure,nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§6Minor pass\"}"]}}}}] run function att2:cinematic/act_4/ithax/area_3/corridor/door_yellow_closing_1
...
# Greenhouse
execute if score area3_red_door1 ITHAX matches 0 if entity @a[x=-7446,y=158,z=-5882,dx=2,dy=-2,dz=2,gamemode=adventure,nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§4Major pass\"}"]}}}}] run function att2:cinematic/act_4/ithax/area_3/greenhouse/door_red_opening_1
execute if score area3_red_door1 ITHAX matches 1 unless entity @a[x=-7446,y=158,z=-5882,dx=2,dy=-2,dz=2,gamemode=adventure,nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§4Major pass\"}"]}}}}] run function att2:cinematic/act_4/ithax/area_3/greenhouse/door_red_closing_1
