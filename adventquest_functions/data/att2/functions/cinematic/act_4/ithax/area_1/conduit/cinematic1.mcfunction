...
execute if score Real0 TIMER matches 21 if entity @e[nbt={UUID:[I;0,123,0,123]},x=-7430,y=164,z=-6007,distance=..0.9] run function att2:cinematic/real0_iteration
