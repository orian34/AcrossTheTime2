...
scoreboard players set area1_event1 ITHAX 0
scoreboard players set area1_event2 ITHAX 0
scoreboard players set area1_event3 ITHAX 0
scoreboard players set area1_event4 ITHAX 0
scoreboard players set area1_event5 ITHAX 0
scoreboard players set area1_event6 ITHAX 0
scoreboard players set area1_event7 ITHAX 0
scoreboard players set area1_event8 ITHAX 0
