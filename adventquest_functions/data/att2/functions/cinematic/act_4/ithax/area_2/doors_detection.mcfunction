...
# Labo 1
execute if score area2_yellow_door1 ITHAX matches 0 if entity @a[x=-7414,y=158,z=-5946,dx=2,dy=-2,dz=2,gamemode=adventure,nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§6Minor pass\"}"]}}}}] run function att2:cinematic/act_4/ithax/area_2/labo_1/door_yellow_opening_1
execute if score area2_yellow_door1 ITHAX matches 1 unless entity @a[x=-7414,y=158,z=-5946,dx=2,dy=-2,dz=2,gamemode=adventure,nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§6Minor pass\"}"]}}}}] run function att2:cinematic/act_4/ithax/area_2/labo_1/door_yellow_closing_1
...
# Cryo room
execute if score area2_yellow_door2 ITHAX matches 0 if entity @a[x=-7448,y=158,z=-5969,dx=2,dy=-2,dz=2,gamemode=adventure,nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§6Minor pass\"}"]}}}}] run function att2:cinematic/act_4/ithax/area_2/cryo_room/door_yellow_opening_1
execute if score area2_yellow_door2 ITHAX matches 1 unless entity @a[x=-7448,y=158,z=-5969,dx=2,dy=-2,dz=2,gamemode=adventure,nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§6Minor pass\"}"]}}}}] run function att2:cinematic/act_4/ithax/area_2/cryo_room/door_yellow_closing_1
...
execute if score area2_red_door1 ITHAX matches 0 if entity @a[x=-7435,y=158,z=-5973,dx=2,dy=-2,dz=2,gamemode=adventure,nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§4Major pass\"}"]}}}}] run function att2:cinematic/act_4/ithax/area_2/corridor/door_red_opening_1
...
# Machine room
execute if score area2_red_door2 ITHAX matches 0 if entity @a[x=-7428,y=158,z=-5960,dx=2,dy=-2,dz=2,gamemode=adventure,nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§4Major pass\"}"]}}}}] run function att2:cinematic/act_4/ithax/area_2/machine_room/door_red_opening_1
execute if score area2_red_door2 ITHAX matches 1 unless entity @a[x=-7428,y=158,z=-5960,dx=2,dy=-2,dz=2,gamemode=adventure,nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§4Major pass\"}"]}}}}] run function att2:cinematic/act_4/ithax/area_2/machine_room/door_red_closing_1
...
# Cryo room
execute if score area2_red_door3 ITHAX matches 0 if entity @a[x=-7438,y=158,z=-5961,dx=2,dy=-2,dz=2,gamemode=adventure,nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§4Major pass\"}"]}}}}] run function att2:cinematic/act_4/ithax/area_2/cryo_room/door_red_opening_1
execute if score area2_red_door3 ITHAX matches 1 unless entity @a[x=-7438,y=158,z=-5961,dx=2,dy=-2,dz=2,gamemode=adventure,nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§4Major pass\"}"]}}}}] run function att2:cinematic/act_4/ithax/area_2/cryo_room/door_red_closing_1
