...
execute if score Real0 TIMER matches 20 run function att2:voice/ithil/ithil4
execute if score Real0 TIMER matches 200 run function att2:cinematic/act_4/ryliath/ithil_2_action_1
