...
execute if score Mainquest SIDEQUEST matches ..91 if entity @a[x=-5338,y=145,z=-5967,dx=-15,dy=-11,dz=-3,gamemode=adventure] run function att2:voice/guard/guard8
