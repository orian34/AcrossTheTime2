...
execute if score Real0 TIMER matches 400 run function att2:dialogs/mainquest/act_2/ch4_player_5
execute if score Real0 TIMER matches 460 run function att2:cinematic/act_2/meleim/indralorth_1_dialog_2
execute if score Real0 TIMER matches 790 run function att2:cinematic/act_2/meleim/indralorth_1_dialog_3
execute if score Real0 TIMER matches 800 run scoreboard players set indra_lorth_PNJ DIALOG 1
execute if score Real0 TIMER matches 800 run function att2:physicmod/reg1/meleim/indra_lorth_door_open
execute if score Real0 TIMER matches 801 run scoreboard players set Mainquest SIDEQUEST 21
...
execute if score Real0 TIMER matches 801.. run setblock -3760 95 -5912 minecraft:air
