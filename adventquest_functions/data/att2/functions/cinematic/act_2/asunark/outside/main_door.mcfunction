...
execute positioned -3554 74 -4942 as @a[distance=..20] run scoreboard players set @s SHAKE_H 80
execute positioned -3554 74 -4942 as @a[distance=..30] run scoreboard players set @s SHAKE_L 80
