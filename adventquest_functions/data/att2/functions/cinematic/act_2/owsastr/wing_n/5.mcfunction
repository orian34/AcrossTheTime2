...
#UN 1 DN 2
#set score replace @e
execute as @e[nbt={UUID:[I;0,65679,0,65679]},tag=UtoN] run scoreboard players set n_5 OW_LIGHT 1
execute as @e[nbt={UUID:[I;0,65679,0,65679]},tag=DtoN] run scoreboard players set n_5 OW_LIGHT 2
