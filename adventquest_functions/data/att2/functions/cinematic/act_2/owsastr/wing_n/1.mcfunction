...
#DS 1 DN 2
#set score replace @e
execute as @e[nbt={UUID:[I;0,65615,0,65615]},tag=DtoS] run scoreboard players set n_1 OW_LIGHT 1
execute as @e[nbt={UUID:[I;0,65615,0,65615]},tag=DtoN] run scoreboard players set n_1 OW_LIGHT 2
