...
execute if score Real0 TIMER matches 30 run function att2:voice/serile/serile57
...
execute if score Real0 TIMER matches 200 run function att2:voice/serile/serile58
...
execute if score Real0 TIMER matches 700 run function att2:voice/serile/serile61
...
execute if score Real0 TIMER matches 900 run function att2:voice/serile/serile62
...
execute if score Real0 TIMER matches 1250 run function att2:voice/serile/serile63
