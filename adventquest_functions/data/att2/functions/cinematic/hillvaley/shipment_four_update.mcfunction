...
summon minecraft:shulker 1973 98 1991 {Tags:["Objective"],NoAI:1,Silent:1,Invulnerable:1,Glowing:1,PersistenceRequired:1,active_effects:[{id:invisibility,amplifier:1,duration:2147483647,ambient:1,show_particles:0b}],DeathLootTable:"att2:empty"}
