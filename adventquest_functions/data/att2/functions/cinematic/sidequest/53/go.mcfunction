...
execute if score SQ53 SIDEQUEST matches 2 if entity @a[x=-1579.5,y=28.5,z=-604.5,distance=..7,gamemode=adventure,nbt={Inventory:[{id:"minecraft:emerald_block",Count:1b,tag:{display:{"Lore":["{\"text\":\"§4§oEmerald of Innocence\"}"]}}}]}] run function att2:cinematic/sidequest/53/end
