...
summon minecraft:wither_skeleton 3429 35 3730 {Rotation:[-60.0f,30.0f],UUID:[I;0,1594,0,1594],Tags:[PNJ],NoAI:1,Invulnerable:1,CustomName:"\"ETERNAN SOLDIER\"",CustomNameVisible:1,Silent:1,PersistenceRequired:1,Attributes:[{Name:generic.attack_damage,Base:0.0},{Name:generic.max_health,Base:1.0}],Health:1,HandItems:[{id:"minecraft:golden_sword",Count:1b,tag:{Enchantments:[{id:"minecraft:fire_aspect",lvl:2}]}},{id:"minecraft:shield",Count:1,tag:{BlockEntityTag:{Base:11,Patterns:[{Pattern:flo,Color:14},{Pattern:mr,Color:1},{Pattern:mc,Color:0},{Pattern:gru,Color:1},{Pattern:gra,Color:1}]}}}],ArmorItems:[{id:"minecraft:leather_boots",Count:1,tag:{display:{color:5511704},Enchantments:[{id:"minecraft:blast_protection",lvl:7}]}},{id:"minecraft:leather_leggings",Count:1,tag:{display:{color:9589788},Enchantments:[{id:"minecraft:blast_protection",lvl:7}]}},{id:"minecraft:leather_chestplate",Count:1,tag:{display:{color:5511704},Enchantments:[{id:"minecraft:blast_protection",lvl:7}]}},{id:"minecraft:player_head",Count:1,tag:{SkullOwner:{Id:[I;1291268178,-1165605281,-1753706018,181597426],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZjFmMTU2NDM1YTJiMjZhYjY2YzMzYmYyMGVmMTY0N2JmY2YyYWVhNGZkMmY2OWI5NzFmY2E3YmE2ZTdjZTMifX19"}]}}}}]}
