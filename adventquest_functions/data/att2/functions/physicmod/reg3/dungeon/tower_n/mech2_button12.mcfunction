#####################################################################
#Made by Adventquest                             					#
#Manage the physical modification for button12 mech2 tower N		#
#####################################################################

setblock -1220 37 -738 minecraft:air
setblock -1220 37 -737 minecraft:iron_block
...
clone -1221 28 -737 -1219 32 -735 -1221 28 -748 replace move