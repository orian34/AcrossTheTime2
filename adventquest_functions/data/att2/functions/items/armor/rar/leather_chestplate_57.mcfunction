...
give @s minecraft:leather_chestplate{EquipmentType:"armor",Rarity:"rar",Manufacturer:"teran",Effect:"str1_her_1",display:{Name:"\"§9Chandail suspect\"","Lore":["{\"text\":\"§7Parmi la foule il sait se cacher,\"}","{\"text\":\"§7et sans que personne ne voie, il frappe.\"}","{\"text\":\"§7Among the crowd he knows how to hide,\"}","{\"text\":\"§7and without anyone seeing, he strikes.\"}","{\"text\":\"§7STR§a1 §7HER§c-1\"}"],color:3487028},Damage:0,Enchantments:[{id:"minecraft:unbreaking",lvl:6s}],AttributeModifiers:[{AttributeName:generic.armor,Name:generic.armor,Amount:4.61,Operation:0,Slot:chest,UUID:[I;0,10002,0,20000]},{AttributeName:generic.armor_toughness,Name:generic.armor_toughness,Amount:2.21,Operation:0,Slot:chest,UUID:[I;0,20002,0,20000]},{AttributeName:generic.knockback_resistance,Name:generic.knockback_resistance,Amount:0.02,Operation:0,Slot:chest,UUID:[I;0,30002,0,20000]}]} 1
