...
tellraw @a[scores={LANGUAGE=0}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Oh à peine, c'était juste la suite de quêtes la plus longue que j'ai eu à faire depuis mon arrivée dans la région...","color":"aqua"}]}


#ENGLISH LANGUAGE

tellraw @a[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Oh barely, it just was the longest quest serie i've had to do since my arrival around here...","color":"aqua"}]}
