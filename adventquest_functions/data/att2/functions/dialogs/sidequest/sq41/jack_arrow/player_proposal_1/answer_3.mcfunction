...
tellraw @s[scores={LANGUAGE=3}] {"text":" °-° ジャック・アロー : ","color":"green","extra":[{"text":"ここにはもう宝物はありません。アスナークの海賊たちがすべてを奪いました！お願いだから、もう問題を起こしたくない、もう十分に苦しんできたんだ...待って、彼らの船の一つが難破した場所を教えることができる。その難破船はここから南の海岸にある。到達するのは簡単ではないから、誰もまだそれを盗んでいないと確信している。","color":"dark_aqua"}]}


#KOREAN LANGUAGE

tellraw @s[scores={LANGUAGE=4}] {"text":" °-° 잭 애로우 : ","color":"green","extra":[{"text":"여기에는 더 이상 보물이 없어요. 아수나크의 해적들이 우리에게서 모든 것을 훔쳐갔습니다! 제발, 우리는 더 이상 문제를 원하지 않아요, 이미 충분히 겪었어요... 기다려, 그들의 배 중 하나가 좌초된 곳을 알려줄 수 있어요. 난파선은 여기서 남쪽 해안에 있습니다. 접근하기 쉽지 않기 때문에 아직 아무도 그것을 훔치지 않았을 것입니다.","color":"dark_aqua"}]}


#ARABIC LANGUAGE

tellraw @s[scores={LANGUAGE=5}] {"text":" °-° جاك آرو : ","color":"green","extra":[{"text":"لم يعد هناك أي كنز هنا، لقد سرق قراصنة أسونارك كل شيء منا! أرجوك، لا نريد أي مشاكل، لقد عانينا بما فيه الكفاية... انتظر، يمكنني أن أرشدك إلى المكان حيث جنحت إحدى سفنهم وتحتوي على غنيمة ضخمة. الحطام يقع جنوبًا من هنا، على الساحل. الوصول إليه ليس سهلاً، ولهذا السبب أنا متأكد من أنه لم يسرقه أحد بعد.","color":"dark_aqua"}]}


#RUSSIAN LANGUAGE

tellraw @s[scores={LANGUAGE=6}] {"text":" °-° Джек Эроу : ","color":"green","extra":[{"text":"Здесь больше нет сокровищ, пираты из Асунарков украли у нас всё! Пожалуйста, мы не хотим никаких проблем, мы уже достаточно натерпелись... Подожди, я могу показать тебе место, где одна из их лодок села на мель, содержащая огромный куш. Кораблекрушение находится к югу отсюда, на побережье. Добраться туда нелегко, поэтому я уверен, что никто еще его не украл.","color":"dark_aqua"}]}
...
tellraw @s[scores={LANGUAGE=9}] {"text":" °-° जैक एरो : ","color":"green","extra":[{"text":"यहां अब कोई खजाना नहीं है, असुनार्क्स के समुद्री डाकुओं ने हमसे सब कुछ चुरा लिया है! कृपया, हम कोई परेशानी नहीं चाहते, हमने पहले ही बहुत झेला है... रुको, मैं तुम्हें वह स्थान दिखा सकता हूँ जहाँ उनका एक जहाज फंसा हुआ है जिसमें एक बड़ा जैकपॉट है। मलबा यहाँ से दक्षिण में तट पर स्थित है। यह पहुँचना आसान नहीं है, इसलिए मुझे यकीन है कि अभी तक किसी ने इसे चुराया नहीं है।","color":"dark_aqua"}]}
