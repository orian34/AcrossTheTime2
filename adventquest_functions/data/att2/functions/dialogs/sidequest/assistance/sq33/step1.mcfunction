...
tellraw @s[scores={LANGUAGE=2}] {"text":"-°- Sylberländ的秘寶 -°- : ","color":"gray","extra":[{"text":"Mortimer 和我談到了佈置在 Sylberländ 不同地方的單體結構。 他讓我藉此機會從我發現這些結構的每個地方帶回石頭樣本。 根據他的信息， 該地區散佈著不同的結構。","color":"aqua","italic":true}]}

#JAPANESE LANGUAGE

tellraw @s[scores={LANGUAGE=3}] {"text":"-°- シルバーラントの宝物 -°- : ","color":"gray","extra":[{"text":"モーティマーはシルバーラントのさまざまな場所に配置されたモノリス構造について話しました。彼は私にこれらの構造が見つかる場所ごとに石のサンプルを取るように頼みました。彼の情報によると、この地域全体には8つの異なる構造が散在しているとのことです。","color":"aqua","italic":true}]}

#KOREAN LANGUAGE

tellraw @s[scores={LANGUAGE=4}] {"text":"-°- 실버란드의 보물 -°- : ","color":"gray","extra":[{"text":"모티머는 실버란드의 다양한 장소에 배치된 돌기둥 구조에 대해 말씀하셨습니다. 그는 이 구조물이 발견된 각 장소에서 돌 샘플을 가져오라고 요청했습니다. 그의 정보에 따르면, 이 지역 전체에는 여덟 가지 다른 구조물이 흩어져 있습니다.","color":"aqua","italic":true}]}

#ARABIC LANGUAGE

tellraw @s[scores={LANGUAGE=5}] {"text":"-°- كنز سيلبرلاند -°- : ","color":"gray","extra":[{"text":"تحدث لي مورتيمر عن هياكل من الأحجار المنبثقة الموضوعة في أماكن مختلفة من سيلبرلاند. طلب مني أن أستغل الفرصة لأحضر عينات من الحجر من كل مكان أجد فيه هذه الهياكل. وفقًا لمعلوماته، هناك ثمانية هياكل مختلفة متناثرة في جميع أنحاء المنطقة.","color":"aqua","italic":true}]}

#RUSSIAN LANGUAGE

tellraw @s[scores={LANGUAGE=6}] {"text":"-°- Сокровище Сильберланд -°- : ","color":"gray","extra":[{"text":"Мортимер рассказал мне о монолитных структурах, размещенных в различных местах Сильберланда. Он попросил меня воспользоваться возможностью и принести образцы камня из каждого места, где я найду эти структуры. По его информации, в регионе разбросаны восемь различных структур.","color":"aqua","italic":true}]}
...
tellraw @s[scores={LANGUAGE=9}] {"text":"-°- सिल्बरलैंड का खजाना -°- : ","color":"gray","extra":[{"text":"मोर्टिमर ने मुझे सिल्बरलैंड के विभिन्न स्थानों पर व्यवस्थित मोनोलिथिक संरचनाओं के बारे में बताया। उन्होंने मुझसे कहा कि मैं इन संरचनाओं को जहां-जहां मिले उन स्थानों से पत्थर के नमूने ले आऊं। उनकी जानकारी के अनुसार, क्षेत्र में फैले हुए आठ विभिन्न संरचनाएँ हैं।","color":"aqua","italic":true}]}
