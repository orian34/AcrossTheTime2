...
tellraw @s[scores={LANGUAGE=3}] {"text":"[シルバーラントの宝物]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/quest/sidequest/sq33/display_progress"},"hoverEvent":{"action":"show_text","value":"クエストの進行状況をチェックし、ヒントを得るにはここをクリックしてください。"}}

#KOREAN LANGUAGE

tellraw @s[scores={LANGUAGE=4}] {"text":"[실버란드의 보물]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/quest/sidequest/sq33/display_progress"},"hoverEvent":{"action":"show_text","value":"이 퀘스트 진행 상황을 확인하고 몇 가지 단서를 얻으려면 여기를 클릭하세요."}}

#ARABIC LANGUAGE

tellraw @s[scores={LANGUAGE=5}] {"text":"[كنز سيلبرلاند]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/quest/sidequest/sq33/display_progress"},"hoverEvent":{"action":"show_text","value":"انقر هنا للتحقق من تقدمك في هذه المهمة والحصول على بعض الأدلة."}}

#RUSSIAN LANGUAGE

tellraw @s[scores={LANGUAGE=6}] {"text":"[Сокровище Сильберланд]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/quest/sidequest/sq33/display_progress"},"hoverEvent":{"action":"show_text","value":"Нажмите здесь, чтобы проверить свой прогресс в этом задании и получить несколько подсказок."}}
...
tellraw @s[scores={LANGUAGE=9}] {"text":"[सिल्बरलैंड का खजाना]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/quest/sidequest/sq33/display_progress"},"hoverEvent":{"action":"show_text","value":"इस उपकरण की प्रगति की जाँच करें और कुछ संकेत प्राप्त करने के लिए यहाँ क्लिक करें."}}
