...
tellraw @s[scores={LANGUAGE=3}] {"text":"-°- ヘレナの馬 -°- : ","color":"gray","extra":[{"text":"エリザ・メリがヘレナの馬を毒物で殺した責任がある。彼女の妹を見つけて、二度と同じことが起こらないように伝えよう。","color":"aqua","italic":true}]}

# KOREAN LANGUAGE

tellraw @s[scores={LANGUAGE=4}] {"text":"-°- 헬레나의 말 -°- : ","color":"gray","extra":[{"text":"엘리사 멜리가 헬레나의 말을 중독시킨 책임이 있다. 그녀의 여동생을 찾아가서 이런 일이 다시는 일어나지 않도록 알려주자.","color":"aqua","italic":true}]}

# ARABIC LANGUAGE

tellraw @s[scores={LANGUAGE=5}] {"text":"-°- حصان هيلينا -°- : ","color":"gray","extra":[{"text":"اليسا ميلي مسؤولة عن تسميم حصان هيلينا. لنذهب لنجد أختها ونخبرها أن هذا لن يحدث مرة أخرى.","color":"aqua","italic":true}]}

# RUSSIAN LANGUAGE

tellraw @s[scores={LANGUAGE=6}] {"text":"-°- Лошади Хелены -°- : ","color":"gray","extra":[{"text":"Элиза Мели виновна в отравлении лошадей Хелены. Пойдем найдем ее сестру и скажем, что это больше не повторится.","color":"aqua","italic":true}]}
...
tellraw @s[scores={LANGUAGE=9}] {"text":"-°- हेलेना के घोड़े -°- : ","color":"gray","extra":[{"text":"एलिसा मेली हेलेना के घोड़ों के जहरीला करारी का जिम्मेदार है। चलो उसकी बहन को ढूंढे और उसे बताएं कि यह फिर से नहीं होगा।","color":"aqua","italic":true}]}
