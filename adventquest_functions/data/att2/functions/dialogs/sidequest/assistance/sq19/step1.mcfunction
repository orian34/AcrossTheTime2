...
tellraw @s[scores={LANGUAGE=3}] {"text":"-°- ヘレナの馬 -°- : ","color":"gray","extra":[{"text":"ヘレナの馬が病気です。どうやら誰かが彼女に恨みを持って、馬に毒入りのリンゴを与えたようです。私はライリアスに行って、彼女に恨みを抱く人物を探してみる必要があります...","color":"aqua","italic":true}]}

# KOREAN LANGUAGE

tellraw @s[scores={LANGUAGE=4}] {"text":"-°- 헬레나의 말 -°- : ","color":"gray","extra":[{"text":"헬레나의 말이 아프다, 누군가 그녀를 원망하고 말에게 독이 든 사과를 줬다는 것 같다. 라일리아스로 가서 그녀를 원망하는 사람을 찾아보자... ","color":"aqua","italic":true}]}

# ARABIC LANGUAGE

tellraw @s[scores={LANGUAGE=5}] {"text":"-°- حصان هيلينا -°- : ","color":"gray","extra":[{"text":"حصان هيلينا مريض، على ما يبدو هناك شخص ما غاضب منها وأعطى تفاح مسموم لحصانها. يجب عليّ الذهاب إلى ريلياث لأرى إذا كان هناك أي شخص قد يكون لديه شعور بالانتقام منها... ","color":"aqua","italic":true}]}

# RUSSIAN LANGUAGE

tellraw @s[scores={LANGUAGE=6}] {"text":"-°- Лошади Хелены -°- : ","color":"gray","extra":[{"text":"Лошади Хелены болеют, по-видимому, кто-то возмущен на нее и дал отравленные яблоки ее лошадям. Мне нужно отправиться в Рилиаф и посмотреть, найду ли кого-то, кто мог бы иметь обиду на нее... ","color":"aqua","italic":true}]}
...
tellraw @s[scores={LANGUAGE=9}] {"text":"-°- हेलेना के घोड़े -°- : ","color":"gray","extra":[{"text":"हेलेना के घोड़े बीमार हैं, लगता है कि कोई उससे नाराज हो गया है और उसके घोड़ों को जहरीले सेब दे रहा है। मुझे राइलियथ जाना होगा देखने के लिए कि क्या कोई उसे कोई दुश्मनी रखता है... ","color":"aqua","italic":true}]}
