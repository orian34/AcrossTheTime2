...
tellraw @s[scores={LANGUAGE=3}] {"text":"-°- 迷惑的な山賊 -°- : ","color":"gray","extra":[{"text":"ラグナルド・ロースが私に与えた任務は、エルベッタの森からすべての山賊キャンプを駆除することです。メレイムの町の近くにある白樺の森です。","color":"aqua","italic":true}]}

#KOREAN LANGUAGE

tellraw @s[scores={LANGUAGE=4}] {"text":"-°- 귀찮은 강도들 -°- : ","color":"gray","extra":[{"text":"라그나르드 로스는 나에게 엘베타 숲의 모든 강도 캠프를 없애는 임무를 맡겼습니다. 메레임 근처의 자작나무 숲입니다.","color":"aqua","italic":true}]}

#ARABIC LANGUAGE

tellraw @s[scores={LANGUAGE=5}] {"text":"-°- اللصوص المزعجون -°- : ","color":"gray","extra":[{"text":"راغنارد لورث أعطاني مهمة التخلص من جميع معسكرات اللصوص في غابة إلفيتا. غابة البتولا بالقرب من بلدة ميليم.","color":"aqua","italic":true}]}

#RUSSIAN LANGUAGE

tellraw @s[scores={LANGUAGE=6}] {"text":"-°- Надоедливые разбойники -°- : ","color":"gray","extra":[{"text":"Рагнард Лорт поручил мне задачу избавить лес Эльветта от всех лагерей разбойников. Березовый лес недалеко от города Мелеим.","color":"aqua","italic":true}]}
...
tellraw @s[scores={LANGUAGE=9}] {"text":"-°- परेशान करने वाले डाकू -°- : ","color":"gray","extra":[{"text":"राग्नार्ड लोर्थ ने मुझे टास्क दिया है कि एल्वेट्टा के वन से सभी उसके डाकू शिविरों को साफ करना है। मेलेम गाँव के पास के बर्च वुड्स।","color":"aqua","italic":true}]}
