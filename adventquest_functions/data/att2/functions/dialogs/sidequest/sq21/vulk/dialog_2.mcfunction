#################################################################
#Made by Adventquest											#
#Use function to process the Dialog 2 of Vulk 					#
#################################################################
...
tellraw @s[scores={LANGUAGE=3}] {"text":" °-° ヴルク : ","color":"green","extra":[{"text":"ヘンリー・ジョーンズ・シニアを覚えていますか？リライズへのポータルの開放が彼に冒険心を与えました！彼はそれを借りて行ったのです…出発前に彼は私に伝説の話をしました：それは私たちの世界では未知の素材で作られた緑がかった装飾が施された非常に奇妙な武器です。それは「ウォールスト」という名の森の寺院に眠っています。私もコレクターなので、もしあなたがそれを手に入れたなら、ぜひ私に持ち帰ってくれると嬉しいです！","color":"dark_aqua"}]}

#KOREAN LANGUAGE

tellraw @s[scores={LANGUAGE=4}] {"text":" °-° 불크 : ","color":"green","extra":[{"text":"헨리 존스 시니어를 기억하나요? 라이어스로 가는 포털의 열림이 그에게 모험의 맛을 주었습니다! 그가 그것을 빌려갔죠… 떠나기 전에 그는 나에게 전설에 대해 이야기했습니다: 우리의 세계에 알려지지 않은 물질로 장식된 녹색의 매우 이상한 무기가 있습니다. 그것은 '워를레스트'라는 숲의 사원에 잠들어 있습니다. 나도 수집가이기 때문에, 당신이 그것을 손에 넣는다면 나에게 가져다 주면 기쁠 것입니다!","color":"dark_aqua"}]}
...
tellraw @s[scores={LANGUAGE=9}] {"text":" °-° वुल्क : ","color":"green","extra":[{"text":"क्या आप हेनरी जोन्स सीनियर को याद करते हैं? रयलाईथ की ओर पोर्टल का उद्घाटन ने उसे साहसिकता का स्वाद दिया! उसने इसे भी उधार लिया... निकलने से पहले उसने मुझे एक किंवदंती के बारे में बताया: एक बहुत अजीब प्रकार का हथियार है जिसमें हमारे विश्व के अज्ञात सामग्रियों से हरे रंग की सजावट है। यह एक 'वॉर्लेस्ट' नामक वन मंदिर में सो रहा है। मैं भी एक संग्रहकर्ता हूं, अगर आप इसे प्राप्त करते हैं, तो मुझे खुशी होगी अगर आप इसे वापस ला सकें।","color":"dark_aqua"}]}
