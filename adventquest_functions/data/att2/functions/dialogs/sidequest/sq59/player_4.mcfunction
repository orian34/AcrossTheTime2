...
tellraw @a[scores={LANGUAGE=0}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Hmm... J'espère que ça ne concerne plus Ranégot, je lui ait réglé son compte définitivement.","color":"aqua"}]}
