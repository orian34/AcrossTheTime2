...
tellraw @a[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Yes, you're lucky because something strange happened at Ëarndhel Temple.","color":"aqua"}]}
