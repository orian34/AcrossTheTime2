...
tellraw @a[scores={LANGUAGE=3}] {"text":" °-° Basile Valentin : ","color":"green","extra":[{"text":"これは、錬金術師の探求を完成するための長年の研究の結果である：賢者の石。私がこの正確な場所を選び、エアンデル神殿の中心にこの物質を置いたのは、当時あなたが持ち帰った9つの宝石の力を使って、精髄に達しその放射を吸収するためである。","color":"dark_aqua"}]}

#KOREAN LANGUAGE

tellraw @a[scores={LANGUAGE=4}] {"text":" °-° Basile Valentin : ","color":"green","extra":[{"text":"이것은 연금술사의 탐구를 완성하기 위한 여러 해의 연구 결과입니다: 철학자의 돌. 내가 이 정확한 장소를 선택하여 이 물질을 어느델 신전의 중심에 두는 것은 당시 당신이 가져온 9개의 보석의 힘을 사용하여 정수에 도달하고 그 방사를 흡수하기 위함입니다.","color":"dark_aqua"}]}

#ARABIC LANGUAGE

tellraw @a[scores={LANGUAGE=5}] {"text":" °-° Basile Valentin : ","color":"green","extra":[{"text":"هذا هو نتيجة سنوات من البحث لإتمام مهمة الكيميائيين: حجر الفلاسفة. إذا اخترت هذا المكان الدقيق لوضع هذه المادة في مركز معبد إيرندهيل، فذلك لاستخدام قوى الأحجار التسعة التي جلبتها في ذلك الوقت للوصول إلى الجوهر وامتصاص إشعاعاته.","color":"dark_aqua"}]}

#RUSSIAN LANGUAGE

tellraw @a[scores={LANGUAGE=6}] {"text":" °-° Basile Valentin : ","color":"green","extra":[{"text":"Это результат многолетних исследований для завершения поиска алхимиков: философский камень. Если я выбрал это точное место для размещения этого вещества в центре храма Эарндхел, то это для использования силы девяти драгоценных камней, которые ты принес в то время, чтобы достичь квинтэссенции и поглотить ее излучения.","color":"dark_aqua"}]}
...
tellraw @a[scores={LANGUAGE=9}] {"text":" °-° Basile Valentin : ","color":"green","extra":[{"text":"यह वर्षों के शोध का परिणाम है जिससे रसायनशास्त्रियों की खोज पूरी हो सके: दार्शनिक पत्थर। अगर मैंने इस सटीक जगह को चुना है तो इस पदार्थ को ईर्न्डेल मंदिर के केंद्र में रखने के लिए, तो यह उन 9 रत्नों की शक्तियों का उपयोग करने के लिए है जिन्हें आपने उस समय लाया था, ताकि क्विंटेसेंस तक पहुंच सकें और उसकी विकिरणों को अवशोषित कर सकें.","color":"dark_aqua"}]}
