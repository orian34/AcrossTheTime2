...
tellraw @a[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"No doubt, this is the barbarian camp. I'm going to have to find a way to get in...","color":"aqua"}]}
