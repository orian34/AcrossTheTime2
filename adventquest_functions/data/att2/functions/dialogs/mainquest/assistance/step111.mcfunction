...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"There, I activated the main mechanism of the western tower. Now I have to head to the eastern tower of the dungeon.","color":"aqua"}]}
