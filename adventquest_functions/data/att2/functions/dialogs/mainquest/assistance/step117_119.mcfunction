...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"This is my first time gem, I have to put it in front of the Ryliath portal.","color":"aqua"}]}
