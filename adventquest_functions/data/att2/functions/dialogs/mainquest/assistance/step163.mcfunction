...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Here is a third emerald fallen, one left! The main door of the northeastern tower has opened.","color":"aqua"}]}
