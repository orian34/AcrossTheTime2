...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"The enemies have finally stopped flocking to the door, I will have to report to the Captain.","color":"aqua"}]}
