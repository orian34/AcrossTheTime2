...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Je peux accéder à une autre tour. Je trouverais au sommet peut-être un moyen de continuer dans l'autre temporalité grâce à mes Pelzion...","color":"aqua"}]}

#ENGLISH LANGUAGE

tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I can access another tower. I should find at the top perhaps a way to continue in the other temporality thanks to my Pelzion ...","color":"aqua"}]}
