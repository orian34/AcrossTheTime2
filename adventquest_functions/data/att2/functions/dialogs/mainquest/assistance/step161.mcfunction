...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I have to face powerful enemies to keep climbing. I'm almost at the end of the southeastern tower.","color":"aqua"}]}
