...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I need to explore the dimension of Billgart in order to find the location of a second time gem.","color":"aqua"}]}
