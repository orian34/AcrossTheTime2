...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I'm almost done. All that remains is to activate the flood mechanism and take the gem.","color":"aqua"}]}
