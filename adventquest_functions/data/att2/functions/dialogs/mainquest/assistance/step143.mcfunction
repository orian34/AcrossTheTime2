...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Here I can continue to climb in the southwestern tower and surely reach another next to it.","color":"aqua"}]}
