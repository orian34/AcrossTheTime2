...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Il faut que je trouve un moyen de continuer de monter vers le sommet de la tour. Je vais devoir trouver une clef d'émeraude pour ouvrir la porte aus sommet...","color":"aqua"}]}

#ENGLISH LANGUAGE

tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I have to find a way to keep climbing to the top of the tower. I'm going to have to find an emerald key to open the door to the top ...","color":"aqua"}]}
