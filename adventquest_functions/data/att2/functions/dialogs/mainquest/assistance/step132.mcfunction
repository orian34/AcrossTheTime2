...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I have to climb into the northwestern tower and find a way to open the emerald gate to continue.","color":"aqua"}]}
