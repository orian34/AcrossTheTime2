...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Here I am in the northern tower but at the bottom... I have to find an emerald key to open the door and climb to the top!","color":"aqua"}]}
