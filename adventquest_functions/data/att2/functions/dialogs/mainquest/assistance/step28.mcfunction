...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Finally the second space gem, I must place it on the altar of Ryliath like the first one.","color":"aqua"}]}
