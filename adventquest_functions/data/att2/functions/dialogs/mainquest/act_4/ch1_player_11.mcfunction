...
tellraw @a[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I am in search of information, the royal family of Ryliath referred me to Eolorion for that.","color":"aqua"}]}
