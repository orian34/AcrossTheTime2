...
tellraw @a[scores={LANGUAGE=3}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"なるほど...まあ、もう選択肢はないようですね...私はあなたをシルベルランドで最も危険な場所に送らなければなりません。ノジェランスはかつて繁栄した街でしたが、暗い出来事がそれを混乱に陥れ、今日では廃墟しか残っていません...","color":"dark_aqua"}]}

# KOREAN LANGUAGE

tellraw @a[scores={LANGUAGE=4}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"알겠습니다... 그래, 더 이상 선택의 여지가 없는 것 같군요... 저는 실버랜드에서 가장 위험한 곳으로 보내야 할 것입니다. 노젤란스는 한 때 번영한 도시였지만, 어두운 사건으로 인해 혼돈에 빠져 오늘날에는 유적만 남아 있습니다...","color":"dark_aqua"}]}

# ARABIC LANGUAGE

tellraw @a[scores={LANGUAGE=5}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"أفهم... حسنًا، أعتقد أنه لا خيار آخر... سأضطر إلى إرسالك إلى أخطر مكان في سيلبرلاند. كانت نوجيلانث مدينة مزدهرة في يوم من الأيام، لكن حدثًا مظلمًا ألقى بها في الفوضى وبقيت اليوم مجرد أطلال...","color":"dark_aqua"}]}

# RUSSIAN LANGUAGE

tellraw @a[scores={LANGUAGE=6}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"Понятно... Что ж, кажется, выбора больше нет... Мне придётся отправить тебя в самое опасное место в Сильберланде. Ноджелант когда-то был процветающим городом, но тёмное событие повергло его в хаос, и сегодня остались лишь руины...","color":"dark_aqua"}]}
...
tellraw @a[scores={LANGUAGE=9}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"समझा... अच्छा, मुझे लगता है कि हमारे पास और कोई विकल्प नहीं है... मुझे तुम्हें सिल्बरलैंड के सबसे खतरनाक स्थान पर भेजना होगा। नोजेलांथ कभी एक समृद्ध शहर था, लेकिन एक अंधेरे घटना ने उसे अराजकता में डाल दिया और आज के दिन केवल विश्राम रह गए हैं...","color":"dark_aqua"}]}
