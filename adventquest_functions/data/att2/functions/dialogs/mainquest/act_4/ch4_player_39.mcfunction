...
# ARABIC LANGUAGE
tellraw @a[scores={LANGUAGE=6}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"هوو... أين يمكنني أن أجد Néleptron آخر ... هناك آلية غريبة قليلاً في الأعلى ، ربما يجب أن أبدأ من هنا.","color":"aqua"}]}

# JAPANESE LANGUAGE
tellraw @a[scores={LANGUAGE=7}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"プッ... 別のネレプトロンをどこで見つけるか... 少し上に奇妙なメカニズムがある、おそらくそこから始めるべきだ。","color":"aqua"}]}

# KOREAN LANGUAGE
tellraw @a[scores={LANGUAGE=8}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"흐음... 다른 넬렙트론을 어디서 찾지... 약간 높은 곳에 이상한 장치가 있어, 아마 그걸로 시작해야겠다.","color":"aqua"}]}
