...
tellraw @a[scores={LANGUAGE=0}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"C'est un Néleptron, il devrait suffire à remettre le mécanisme du pont en état de marche. Je dois m'en emparer.","color":"aqua"}]}
...
tellraw @a[scores={LANGUAGE=3}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"これはネレプトロンだ。橋の仕組みを再稼働させるにはこれで十分なはずだ。手に入れなければ。","color":"aqua"}]}


#KOREAN LANGUAGE

tellraw @a[scores={LANGUAGE=4}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"이것은 네레프트론이다. 다리의 메커니즘을 다시 작동시키기에 충분할 것이다. 반드시 손에 넣어야 한다.","color":"aqua"}]}
...
tellraw @a[scores={LANGUAGE=6}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Это Нелептрон, он должен быть достаточно мощным, чтобы снова запустить механизм моста. Я должен его заполучить.","color":"aqua"}]}
...
tellraw @a[scores={LANGUAGE=9}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"यह एक नेलेप्ट्रोन है, यह पुल की प्रणाली को फिर से चालू करने के लिए पर्याप्त होना चाहिए। मुझे इसे पाना होगा।","color":"aqua"}]}
