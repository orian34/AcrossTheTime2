...
tellraw @a[scores={LANGUAGE=1}] {"text":" °-° Ouran : ","color":"gold","extra":[{"text":"You think so? And for what foolish reason should my magnificent self bestow forgiveness onto a mongrel who insulted me?","color":"dark_aqua"}]}
