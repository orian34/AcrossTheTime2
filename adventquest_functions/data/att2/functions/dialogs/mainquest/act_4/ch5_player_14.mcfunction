...
tellraw @a[scores={LANGUAGE=3}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"ここにいます、またこの駅に閉じ込められました...早く別のポータルを見つけてノジェランスに戻りましょう！","color":"aqua"}]}

# KOREAN LANGUAGE

tellraw @a[scores={LANGUAGE=4}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"여기 있어요, 다시 이 역에 갇혔어요...빨리 다른 포탈을 찾아 노젤란스로 돌아가야 해요!","color":"aqua"}]}

# ARABIC LANGUAGE

tellraw @a[scores={LANGUAGE=5}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"ها أنا، عالق مجددًا في هذا المحطة... لنجد بسرعة بوابة أخرى للعودة إلى نوجيلانث!","color":"aqua"}]}

# RUSSIAN LANGUAGE

tellraw @a[scores={LANGUAGE=6}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Вот я опять, застрял на этой станции... Давайте быстро найдем другой портал, чтобы вернуться в Ноджелант!","color":"aqua"}]}
...
tellraw @a[scores={LANGUAGE=9}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"यहाँ मैं हूं, इस स्टेशन में फिर से फंस गया... जल्दी से दूसरा पोर्टल ढूंढें और नोजेलैंथ वापस आएं!","color":"aqua"}]}
