...
#ENGLISH LANGUAGE
tellraw @s[scores={LANGUAGE=1..}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"STR <strength> allows you to modify, for each level reached, your melee and ranged damage (possibility of going in the negative and obtaining a penalty).","color":"gray","bold":false}]}
