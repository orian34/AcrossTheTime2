...
#ENGLISH LANGUAGE
tellraw @s[scores={LANGUAGE=1..}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"There are nearly 5000 hidden chests in all the dimensions and regions of the game. Golden chests are generally more likely to have powerful items.","color":"gray","bold":false}]}
