...
#FRENCH LANGUAGE
tellraw @s[scores={LANGUAGE=0}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"Les effets d'aptitude sont appliqués à chaque palier (comptabiliser par paire de niveaux) de l'aptitude. Par exemple : si vous avez un total de 0 <STR>, afin d'acquérir le premier effet de force, vous devez atteindre, non pas le niveau 1, mais le niveau 2.","color":"gray","bold":false}]}
