...
#ENGLISH LANGUAGE
tellraw @s[scores={LANGUAGE=1..}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"The Mythical Axe <Kinuil> adds an area effect that scorches enemies. While holding this weapon you are immune to heat debuffs.","color":"gray","bold":false}]}
