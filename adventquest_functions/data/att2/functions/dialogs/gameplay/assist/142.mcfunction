...
#ENGLISH LANGUAGE
tellraw @s[scores={LANGUAGE=1..}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"<Wirth Razgork> in Ryliath opens his adventurer's reserve to you, allowing you to obtain rewards for each level of 150 Exploit points reached.","color":"gray","bold":false}]}
