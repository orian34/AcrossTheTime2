...
#ENGLISH LANGUAGE
tellraw @s[scores={LANGUAGE=1..}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"The Mythical dagger <Lone Shadow> adds a debuff effect that spreads to enemies hit, dealing damage over time.","color":"gray","bold":false}]}
