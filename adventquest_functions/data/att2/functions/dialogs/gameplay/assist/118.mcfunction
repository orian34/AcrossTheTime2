...
#ENGLISH LANGUAGE
tellraw @s[scores={LANGUAGE=1..}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"When your food bar is recharged to the maximum, you gain a small regressive health regeneration according to the difficulty and inoperative in <Nightmare>.","color":"gray","bold":false}]}
