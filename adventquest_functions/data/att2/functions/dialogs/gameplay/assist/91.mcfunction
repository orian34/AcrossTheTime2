...
#ENGLISH LANGUAGE
tellraw @s[scores={LANGUAGE=1..}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"All the opportunities are available to you! Navigate a path by upgrading skills and equipping items of your choice. Be a relentless warrior, a seasoned Dahäl master or an elite sniper...","color":"gray","bold":false}]}
