...
#FRENCH LANGUAGE
tellraw @s[scores={LANGUAGE=0}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"A partir du livre <Conscience> vous pouvez jeter vos <Chronotons> aux sols pour en donner à vos alliés.","color":"gray","bold":false}]}
