...
#ENGLISH LANGUAGE
tellraw @s[scores={LANGUAGE=1..}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"The Mythical Shield <Aveugle rempart> cumulates a resistance effect whenever you parry an enemy hit.","color":"gray","bold":false}]}
