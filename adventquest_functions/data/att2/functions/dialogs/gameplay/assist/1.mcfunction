...
#FRENCH LANGUAGE
tellraw @s[scores={LANGUAGE=0}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"Visualisez vos <Succès> en allant dans les options de Minecraft. Le nombre de points de vos <Exploits> est indiqué à la 5ème page du livre <Conscience>.","color":"gray","bold":false}]}
