...
#ENGLISH LANGUAGE
tellraw @s[scores={LANGUAGE=1..}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"There are 26 different <Dahäl> spells divided into 3 categories: <Destruction>, <Invocation>, <Alteration>. Most of them can be bought from a Dahäl master.","color":"gray","bold":false}]}
