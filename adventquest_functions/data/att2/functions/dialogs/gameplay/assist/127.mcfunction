...
#FRENCH LANGUAGE
tellraw @s[scores={LANGUAGE=0}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"En fin de jeu, les sortilèges vous seront d'une grande aide car très puissants si évolués au niveau maximum.","color":"gray","bold":false}]}
