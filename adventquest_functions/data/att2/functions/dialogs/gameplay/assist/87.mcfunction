...
#ENGLISH LANGUAGE
tellraw @s[scores={LANGUAGE=1..}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"Having negative skills involves a decreasing effect penalty up to a certain limit, so be wise when using a spell, drinking a potion or wearing items.","color":"gray","bold":false}]}
