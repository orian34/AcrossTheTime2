...
#ENGLISH LANGUAGE
tellraw @s[scores={LANGUAGE=1..}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"The Mythical Sword <Fenrir> adds a freezing effect that spreads to enemies hit, preventing them from moving. By holding this weapon you are immune to the cold penalty in Elcheol.","color":"gray","bold":false}]}
