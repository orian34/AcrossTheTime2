...
#ENGLISH LANGUAGE
tellraw @s[scores={LANGUAGE=1..}] {"text":"⊰☼⊱ ","color":"dark_green","bold":true,"extra":[{"text":"The Mythical Sword <Blutfresser> adds a health gain effect for each hit to an enemy.","color":"gray","bold":false}]}
