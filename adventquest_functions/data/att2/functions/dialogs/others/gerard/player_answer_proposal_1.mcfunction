...
tellraw @s[scores={LANGUAGE=5}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[Sí, fui yo, un héroe de las 7 dimensiones, quien reactivó un antiguo portal espacial para viajar de Ryliath a Earndhel en busca del sabio Etotsira. -->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-068a-0000-00000000068a if entity @s[distance=..7] if score gerard_PNJ DIALOG matches 1 run function att2:dialogs/others/gerard/answer_green_1"},"hoverEvent":{"action":"show_text","value":"Haz clic aquí - respuesta 1"}}]}
...
tellraw @s[scores={LANGUAGE=6}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[Ja, ich war es, ein Held der 7 Dimensionen, der ein altes Weltraumportal reaktiviert hat, um von Ryliath nach Earndhel zu reisen und den weisen Etotsira zu finden. -->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-068a-0000-00000000068a if entity @s[distance=..7] if score gerard_PNJ DIALOG matches 1 run function att2:dialogs/others/gerard/answer_green_1"},"hoverEvent":{"action":"show_text","value":"Klicken Sie hier - Antwort 1"}}]}
