...
execute if score @s SPELL44_SLCT matches 1.. unless entity @s[nbt={Inventory:[{tag:{Spell:"spell44"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/book/spell_44,distance=..2,limit=1,sort=nearest]
