...
execute if score @s SPELL2_SLCT matches 1.. unless entity @s[nbt={Inventory:[{tag:{Spell:"spell2"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/book/spell_2,distance=..2,limit=1,sort=nearest]
