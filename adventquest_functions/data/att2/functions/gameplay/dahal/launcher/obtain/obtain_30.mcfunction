...
execute if score @s SPELL30_SLCT matches 1.. unless entity @s[nbt={Inventory:[{tag:{Spell:"spell30"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/book/spell_30,distance=..2,limit=1,sort=nearest]
