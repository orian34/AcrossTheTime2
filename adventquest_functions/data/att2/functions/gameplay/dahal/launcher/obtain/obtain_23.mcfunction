...
execute if score @s SPELL23_SLCT matches 1.. unless entity @s[nbt={Inventory:[{tag:{Spell:"spell23"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/book/spell_23,distance=..2,limit=1,sort=nearest]
