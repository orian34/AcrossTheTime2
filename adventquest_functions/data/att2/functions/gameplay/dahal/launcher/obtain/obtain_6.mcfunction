...
execute if score @s SPELL6_SLCT matches 1.. unless entity @s[nbt={Inventory:[{tag:{Spell:"spell6"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/book/spell_6,distance=..2,limit=1,sort=nearest]
