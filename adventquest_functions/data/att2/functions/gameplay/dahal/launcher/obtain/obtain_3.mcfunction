...
execute if score @s SPELL3_SLCT matches 1.. unless entity @s[nbt={Inventory:[{tag:{Spell:"spell3"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/book/spell_3,predicate=att2_pre:dahal/pickup,limit=1,sort=nearest]
