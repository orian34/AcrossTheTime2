...
execute if score @s SPELL11_SLCT matches 1.. unless entity @s[nbt={Inventory:[{tag:{Spell:"spell11"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/book/spell_11,distance=..2,limit=1,sort=nearest]
