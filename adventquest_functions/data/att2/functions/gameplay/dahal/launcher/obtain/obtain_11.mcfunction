...
execute unless score @s SPELL11_SLCT matches 1.. run scoreboard players set @s SPELL11_SLCT 1
execute unless score @s SPELL11_SLCT matches 1.. run function att2:gameplay/dahal/launcher/spell_11/lvl1
