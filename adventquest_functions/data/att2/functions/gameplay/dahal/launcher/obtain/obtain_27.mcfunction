...
execute if score @s SPELL27_SLCT matches 1.. unless entity @s[nbt={Inventory:[{tag:{Spell:"spell27"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/book/spell_27,distance=..2,limit=1,sort=nearest]
