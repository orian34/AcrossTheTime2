...
execute if score @s SPELL31_SLCT matches 1.. unless entity @s[nbt={Inventory:[{tag:{Spell:"spell31"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/book/spell_31,predicate=att2_pre:dahal/pickup,limit=1,sort=nearest]
