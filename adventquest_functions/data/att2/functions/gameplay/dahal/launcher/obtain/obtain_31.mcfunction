...
execute unless score @s SPELL31_SLCT matches 1.. run scoreboard players set @s SPELL31_SLCT 1
execute unless score @s SPELL31_SLCT matches 1.. run function att2:gameplay/dahal/launcher/spell_31/lvl1
