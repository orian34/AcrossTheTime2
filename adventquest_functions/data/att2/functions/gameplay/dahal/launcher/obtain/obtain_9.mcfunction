...
execute if score @s SPELL9_SLCT matches 1.. unless entity @s[nbt={Inventory:[{tag:{Spell:"spell9"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/book/spell_9,distance=..2,limit=1,sort=nearest]
