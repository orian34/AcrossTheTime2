...
execute if score @s SPELL43_SLCT matches 1.. unless entity @s[nbt={Inventory:[{tag:{Spell:"spell43"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/book/spell_43,distance=..2,limit=1,sort=nearest]
