...
execute if score @s SPELL25_SLCT matches 1.. unless entity @s[nbt={Inventory:[{tag:{Spell:"spell25"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/book/spell_25,predicate=att2_pre:dahal/pickup,limit=1,sort=nearest]
