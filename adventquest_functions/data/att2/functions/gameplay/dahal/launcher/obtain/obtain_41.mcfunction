...
execute if score @s SPELL41_SLCT matches 1.. unless entity @s[nbt={Inventory:[{tag:{Spell:"spell41"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/book/spell_41,distance=..2,limit=1,sort=nearest]
