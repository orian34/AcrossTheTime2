...
execute as @s[scores={SPELL1_SLCT=4,DAHAL=115..}] anchored eyes at @s positioned ^ ^ ^1.2 run function att2:gameplay/dahal/action/spell1/lvl4
execute as @s[scores={SPELL1_SLCT=5,DAHAL=140..}] anchored eyes at @s positioned ^ ^ ^1.2 run function att2:gameplay/dahal/action/spell1/lvl5
execute as @s[scores={SPELL1_SLCT=6,DAHAL=160..}] anchored eyes at @s positioned ^ ^ ^1.2 run function att2:gameplay/dahal/action/spell1/lvl6
execute as @s[scores={SPELL1_SLCT=7,DAHAL=180..}] anchored eyes at @s positioned ^ ^ ^1.2 run function att2:gameplay/dahal/action/spell1/lvl7
execute as @s[scores={SPELL1_SLCT=8,DAHAL=200..}] anchored eyes at @s positioned ^ ^ ^1.2 run function att2:gameplay/dahal/action/spell1/lvl8
execute as @s[scores={SPELL1_SLCT=9,DAHAL=220..}] anchored eyes at @s positioned ^ ^ ^1.2 run function att2:gameplay/dahal/action/spell1/lvl9
execute as @s[scores={SPELL1_SLCT=10,DAHAL=250..}] anchored eyes at @s positioned ^ ^ ^1.2 run function att2:gameplay/dahal/action/spell1/lvl10
