...
execute anchored eyes at @s positioned ^ ^ ^1.5 run summon minecraft:fireball ~ ~ ~ {Tags:["FireballSpell","STOP"],ExplosionPower:7,Motion:[0.0,0.0,0.0]}
execute at @s positioned 0.0 0.0 0.0 run summon minecraft:armor_stand ^ ^ ^1.1 {Marker:1,Tags:["POS"],Invulnerable:1b,Invisible:1b}
