...
execute as @e[tag=SpaceTeleportSpellSETB,tag=player1] at @s run scoreboard players set @a[distance=..40,scores={NUMEROJOUEUR=1,SPELL32_SLCT=1,SPELL32_SET_OR_TP=4},limit=1,sort=nearest] TP_CHECK 1
execute as @e[tag=SpaceTeleportSpellSETB,tag=player2] at @s run scoreboard players set @a[distance=..40,scores={NUMEROJOUEUR=2,SPELL32_SLCT=1,SPELL32_SET_OR_TP=4},limit=1,sort=nearest] TP_CHECK 1
execute as @e[tag=SpaceTeleportSpellSETB,tag=player3] at @s run scoreboard players set @a[distance=..40,scores={NUMEROJOUEUR=3,SPELL32_SLCT=1,SPELL32_SET_OR_TP=4},limit=1,sort=nearest] TP_CHECK 1
execute as @e[tag=SpaceTeleportSpellSETB,tag=player4] at @s run scoreboard players set @a[distance=..40,scores={NUMEROJOUEUR=4,SPELL32_SLCT=1,SPELL32_SET_OR_TP=4},limit=1,sort=nearest] TP_CHECK 1
execute as @e[tag=SpaceTeleportSpellSETB,tag=player5] at @s run scoreboard players set @a[distance=..40,scores={NUMEROJOUEUR=5,SPELL32_SLCT=1,SPELL32_SET_OR_TP=4},limit=1,sort=nearest] TP_CHECK 1
