...
##对应玩家编号创建传送特效盔甲架
execute as @s[scores={NUMEROJOUEUR=1}] run summon minecraft:armor_stand ~ ~-2 ~ {Marker:1,DisabledSlots:4869972,Invulnerable:1b,Invisible:1b,NoGravity:1b,ShowArms:0b,Tags:["Spell32ArmorStand","SpaceTeleportSpellParticle","player1"]}
execute as @s[scores={NUMEROJOUEUR=2}] run summon minecraft:armor_stand ~ ~-2 ~ {Marker:1,DisabledSlots:4869972,Invulnerable:1b,Invisible:1b,NoGravity:1b,ShowArms:0b,Tags:["Spell32ArmorStand","SpaceTeleportSpellParticle","player2"]}
execute as @s[scores={NUMEROJOUEUR=3}] run summon minecraft:armor_stand ~ ~-2 ~ {Marker:1,DisabledSlots:4869972,Invulnerable:1b,Invisible:1b,NoGravity:1b,ShowArms:0b,Tags:["Spell32ArmorStand","SpaceTeleportSpellParticle","player3"]}
execute as @s[scores={NUMEROJOUEUR=4}] run summon minecraft:armor_stand ~ ~-2 ~ {Marker:1,DisabledSlots:4869972,Invulnerable:1b,Invisible:1b,NoGravity:1b,ShowArms:0b,Tags:["Spell32ArmorStand","SpaceTeleportSpellParticle","player4"]}
execute as @s[scores={NUMEROJOUEUR=5}] run summon minecraft:armor_stand ~ ~-2 ~ {Marker:1,DisabledSlots:4869972,Invulnerable:1b,Invisible:1b,NoGravity:1b,ShowArms:0b,Tags:["Spell32ArmorStand","SpaceTeleportSpellParticle","player5"]}
