...
##对应玩家编号创建传送点所需盔甲架
execute as @s[scores={NUMEROJOUEUR=1}] run summon minecraft:armor_stand ~ ~-1.6 ~ {CustomName:"\"α Waypoint->1\"",CustomNameVisible:1b,Marker:1,DisabledSlots:4869972,Invulnerable:1b,Invisible:1b,NoGravity:1b,ShowArms:0b,Tags:["Spell32ArmorStandSet","SpaceTeleportSpellSETA","player1","Protect"]}
execute as @s[scores={NUMEROJOUEUR=2}] run summon minecraft:armor_stand ~ ~-1.6 ~ {CustomName:"\"α Waypoint->2\"",CustomNameVisible:1b,Marker:1,DisabledSlots:4869972,Invulnerable:1b,Invisible:1b,NoGravity:1b,ShowArms:0b,Tags:["Spell32ArmorStandSet","SpaceTeleportSpellSETA","player2","Protect"]}
execute as @s[scores={NUMEROJOUEUR=3}] run summon minecraft:armor_stand ~ ~-1.6 ~ {CustomName:"\"α Waypoint->3\"",CustomNameVisible:1b,Marker:1,DisabledSlots:4869972,Invulnerable:1b,Invisible:1b,NoGravity:1b,ShowArms:0b,Tags:["Spell32ArmorStandSet","SpaceTeleportSpellSETA","player3","Protect"]}
execute as @s[scores={NUMEROJOUEUR=4}] run summon minecraft:armor_stand ~ ~-1.6 ~ {CustomName:"\"α Waypoint->4\"",CustomNameVisible:1b,Marker:1,DisabledSlots:4869972,Invulnerable:1b,Invisible:1b,NoGravity:1b,ShowArms:0b,Tags:["Spell32ArmorStandSet","SpaceTeleportSpellSETA","player4","Protect"]}
execute as @s[scores={NUMEROJOUEUR=5}] run summon minecraft:armor_stand ~ ~-1.6 ~ {CustomName:"\"α Waypoint->5\"",CustomNameVisible:1b,Marker:1,DisabledSlots:4869972,Invulnerable:1b,Invisible:1b,NoGravity:1b,ShowArms:0b,Tags:["Spell32ArmorStandSet","SpaceTeleportSpellSETA","player5","Protect"]}
