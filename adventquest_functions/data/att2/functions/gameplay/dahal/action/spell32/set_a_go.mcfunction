...
execute if entity @s[scores={tp_spell32_timer=..0}] unless entity @s[scores={DIMENSION=2}] as @s[scores={SPELL_SLCT=313,DAHAL=350..},nbt={Inventory:[{tag:{display:{"Lore":["{\"text\":\"§5§oPrecious!!\"}","{\"text\":\"§5Very, VERY, Precious...\"}"]}}}]}] run function att2:gameplay/dahal/action/spell32/set_armorstand/lvl3_set_a
execute if entity @s[scores={tp_spell32_timer=..0}] unless entity @s[scores={DIMENSION=2}] as @s[scores={SPELL_SLCT=314,DAHAL=350..},nbt={Inventory:[{tag:{display:{"Lore":["{\"text\":\"§5§oPrecious!!\"}","{\"text\":\"§5Very, VERY, Precious...\"}"]}}}]}] run function att2:gameplay/dahal/action/spell32/set_armorstand/lvl4_set_a
execute if entity @s[scores={tp_spell32_timer=..0}] unless entity @s[scores={DIMENSION=2}] as @s[scores={SPELL_SLCT=315,DAHAL=350..},nbt={Inventory:[{tag:{display:{"Lore":["{\"text\":\"§5§oPrecious!!\"}","{\"text\":\"§5Very, VERY, Precious...\"}"]}}}]}] run function att2:gameplay/dahal/action/spell32/set_armorstand/lvl5_set_a
##player color
