...
execute at @a[gamemode=adventure] as @s if score @a[distance=..0,limit=1] NUMEROJOUEUR = @s SPELL6_OWNER as @e[distance=..4,scores={GAMELEVEL=0..},team=hostile] run function att2:gameplay/dahal/action/spell6/damage with storage spdamage
