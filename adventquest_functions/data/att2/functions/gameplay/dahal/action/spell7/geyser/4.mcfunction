...
execute at @a[gamemode=adventure] as @s if score @a[limit=1] NUMEROJOUEUR = @s SPELL7_OWNER as @e[distance=..3,scores={GAMELEVEL=0..},team=hostile] run function att2:gameplay/dahal/action/spell7/damage with storage spdamage