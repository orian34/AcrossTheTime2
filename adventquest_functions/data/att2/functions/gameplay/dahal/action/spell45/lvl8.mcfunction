...
scoreboard players set @a[distance=..8,scores={HER_LVL_DAM=..3}] HER_LVL_DAM 3
scoreboard players set @a[distance=..8,scores={HER_LVL_DAM=..3}] TIMER_HER_DAM 1500
scoreboard players set @a[distance=..8,scores={STR_LVL_DAB=..5}] STR_LVL_DAB 5
scoreboard players set @a[distance=..8,scores={STR_LVL_DAB=..5}] TIMER_STR_DAB 1500
#effect other 
