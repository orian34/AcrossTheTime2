...
scoreboard players set @a[distance=..7,scores={HER_LVL_DAM=..4}] HER_LVL_DAM 4
scoreboard players set @a[distance=..7,scores={HER_LVL_DAM=..4}] TIMER_HER_DAM 1250
scoreboard players set @a[distance=..7,scores={STR_LVL_DAB=..4}] STR_LVL_DAB 4
scoreboard players set @a[distance=..7,scores={STR_LVL_DAB=..4}] TIMER_STR_DAB 1250
#effect other 
