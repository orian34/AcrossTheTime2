...
scoreboard players set @a[distance=..5,scores={HER_LVL_DAM=..4}] HER_LVL_DAM 4
scoreboard players set @a[distance=..5,scores={HER_LVL_DAM=..4}] TIMER_HER_DAM 800
scoreboard players set @a[distance=..5,scores={STR_LVL_DAB=..3}] STR_LVL_DAB 3
scoreboard players set @a[distance=..5,scores={STR_LVL_DAB=..3}] TIMER_STR_DAB 800
#effect other 
