...
scoreboard players set @a[distance=..4,scores={HER_LVL_DAM=..3}] HER_LVL_DAM 3
scoreboard players set @a[distance=..4,scores={HER_LVL_DAM=..3}] TIMER_HER_DAM 600
scoreboard players set @a[distance=..4,scores={STR_LVL_DAB=..2}] STR_LVL_DAB 2
scoreboard players set @a[distance=..4,scores={STR_LVL_DAB=..2}] TIMER_STR_DAB 600
#effect other 
