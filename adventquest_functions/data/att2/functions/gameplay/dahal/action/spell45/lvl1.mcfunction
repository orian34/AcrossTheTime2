...
scoreboard players set @a[distance=..2,scores={HER_LVL_DAM=..3}] HER_LVL_DAM 3
scoreboard players set @a[distance=..2,scores={HER_LVL_DAM=..3}] TIMER_HER_DAM 200
scoreboard players set @a[distance=..2,scores={STR_LVL_DAB=..1}] STR_LVL_DAB 1
scoreboard players set @a[distance=..2,scores={STR_LVL_DAB=..1}] TIMER_STR_DAB 200
#effect other 
