...
scoreboard players set @a[distance=..9,scores={HER_LVL_DAM=..2}] HER_LVL_DAM 2
scoreboard players set @a[distance=..9,scores={HER_LVL_DAM=..2}] TIMER_HER_DAM 1750
scoreboard players set @a[distance=..9,scores={STR_LVL_DAB=..6}] STR_LVL_DAB 6
scoreboard players set @a[distance=..9,scores={STR_LVL_DAB=..6}] TIMER_STR_DAB 1750
#effect other 
