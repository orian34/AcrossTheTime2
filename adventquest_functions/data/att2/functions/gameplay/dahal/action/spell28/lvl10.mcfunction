...
give @s minecraft:bow{EquipmentType:"rangeWeapon",EquipmentID:"spectralbow",Rarity:"leg",Manufacturer:"traditional",Unbreakable:1,display:{Name:"\"§6Arc spectral\"","Lore":["{\"text\":\"§7Etends l'influence de ton maître\"}","{\"text\":\"§7pour 15 secondes.\"}","{\"text\":\"§7Extend your master's influence\"}","{\"text\":\"§7for 15 seconds."]},CustomModelData:1000000,Enchantments:[{id:"minecraft:power",lvl:20s},{id:"minecraft:infinity",lvl:1s}]} 1
...
scoreboard players set @s SPELL28_EFFECT 666