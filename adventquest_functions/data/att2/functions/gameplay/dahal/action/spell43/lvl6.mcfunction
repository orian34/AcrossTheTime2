...
particle minecraft:dust 0.9 0.9 0.1 3.25 ~ ~1 ~ 0.1 0.1 0.1 0 6 normal @s
particle minecraft:dust 0.9 0.9 0.1 2.25 ~ ~1 ~ 0.2 1 0.2 0 10 normal @a[distance=1..]
effect give @s minecraft:absorption 1000000 5 true
