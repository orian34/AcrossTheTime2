...
execute as @a[distance=..6] at @s run function att2:gameplay/dahal/action/spell43/effect
execute as @a[distance=..6] at @s run particle minecraft:dust 0.9 0.9 0.1 3.25 ~ ~1 ~ 0.1 0.1 0.1 0 6 normal
effect give @s minecraft:absorption infinite 5 true
##other players
execute at @s as @a[distance=..6] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run effect give @s minecraft:absorption infinite 3 true
#effect other 
