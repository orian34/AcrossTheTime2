...
execute as @a[distance=..3] at @s run particle minecraft:dust 0.9 0.9 0.1 2.5 ~ ~1 ~ 0.1 0.1 0.1 0 3 normal
effect give @s minecraft:absorption infinite 2 true
##other players
execute at @s as @a[distance=..3] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run effect give @s minecraft:absorption infinite 1 true
#effect other 
