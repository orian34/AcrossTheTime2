...
scoreboard players set minDG SPDG 75
scoreboard players set maxDG SPDG 225
scoreboard players operation maxDG SPDG -= minDG SPDG
#cal  (SLCT_LVL-1)
scoreboard players operation slctlvl SPDG = @s SPELL5_SLCT
...
scoreboard players operation enhancementBONUS SPDG = BonusPowerSpell5 ENHANCEMENT
...
execute store result storage spdamage SP5 int 1 run scoreboard players get finalDG SPDG
#reset
