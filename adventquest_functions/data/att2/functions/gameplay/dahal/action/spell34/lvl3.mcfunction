...
execute if score @s LIMIT34 matches ..9 as @s run function att2:dialogs/gameplay/dahal/spell34_reveal
execute if score @s LIMIT34 matches 10.. as @s run function att2:dialogs/gameplay/dahal/spell34_reveal_max

scoreboard players remove @s DAHAL 140
function att2:gameplay/dahal/action/spell34/cooldown
scoreboard players add @s SPELL34_LVL 2
