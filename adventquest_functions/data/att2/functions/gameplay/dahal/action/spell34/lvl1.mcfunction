...
execute if score @s LIMIT77 matches ..3 as @s run function att2:dialogs/gameplay/dahal/spell34_reveal
execute if score @s LIMIT77 matches 4.. as @s run function att2:dialogs/gameplay/dahal/spell34_reveal_max
