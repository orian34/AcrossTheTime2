...
execute unless score choice SQ30 matches 1..2 positioned -4951 145 -4920 if data block ~ ~ ~ {LootTable:"att2:chest/reg1/c6t7"} run function att2:gameplay/dahal/action/spell34/create_chest_marker
