...
execute if score @s LIMIT34 matches ..34 as @s run function att2:dialogs/gameplay/dahal/spell34_reveal
execute if score @s LIMIT34 matches 35.. as @s run function att2:dialogs/gameplay/dahal/spell34_reveal_max
