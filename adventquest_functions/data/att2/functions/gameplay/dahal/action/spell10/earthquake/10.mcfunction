...
particle minecraft:item minecraft:iron_block ~ ~0.2 ~ 5 0.25 5 0.1 10 normal
particle minecraft:item minecraft:gray_concrete ~ ~0.2 ~ 5 0.25 5 0.1 10 normal
particle minecraft:item minecraft:dirt ~ ~0.2 ~ 5 0.25 5 0.1 10 normal
particle minecraft:ash ~ ~0.2 ~ 5 0.25 5 0.1 100 normal
particle minecraft:campfire_cosy_smoke ~ ~ ~ 5 0 5 0.01 10 normal
