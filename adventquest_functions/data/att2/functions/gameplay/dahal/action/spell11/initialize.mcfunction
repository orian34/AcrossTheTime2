...
scoreboard players set cap2 SPELL11_LVL 100
scoreboard players set cap3 SPELL11_LVL 400
scoreboard players set cap4 SPELL11_LVL 1000
scoreboard players set cap5 SPELL11_LVL 2000
scoreboard players set cap6 SPELL11_LVL 3500
scoreboard players set cap7 SPELL11_LVL 7000
scoreboard players set cap8 SPELL11_LVL 12000
scoreboard players set cap9 SPELL11_LVL 20000
scoreboard players set cap10 SPELL11_LVL 32000