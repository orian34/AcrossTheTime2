...
scoreboard players operation enhancementBONUS SPDG = BonusPowerSpell11 ENHANCEMENT
...
execute store result storage spdamage SP11 int 1 run scoreboard players get finalDG SPDG
#reset
