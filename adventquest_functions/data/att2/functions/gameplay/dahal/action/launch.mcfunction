...
execute as @s[scores={SPELL_SLCT=301..310,COOLDOWN31=1..}] run function att2:gameplay/dahal/action/loadingfail
...
###SpaceTeleport
execute as @s[scores={SPELL_SLCT=311..315,COOLDOWN32=..0,SPELL32_SET_OR_TP=1}] at @s run function att2:gameplay/dahal/action/spell32/set_a_go
execute as @s[scores={SPELL_SLCT=311..315,COOLDOWN32=..0,SPELL32_SET_OR_TP=2}] at @s run function att2:gameplay/dahal/action/spell32/set_b_go
execute as @s[scores={SPELL_SLCT=311..315,COOLDOWN32=..0,SPELL32_SET_OR_TP=3}] at @s run function att2:gameplay/dahal/action/spell32/tp_a_go
execute as @s[scores={SPELL_SLCT=311..315,COOLDOWN32=..0,SPELL32_SET_OR_TP=4}] at @s run function att2:gameplay/dahal/action/spell32/tp_b_go
