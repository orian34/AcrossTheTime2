...
effect give @a[distance=..5] minecraft:invisibility 40 0 true
scoreboard players set @a[distance=..5,scores={HUN_LVL_DAM=..3}] HUN_LVL_DAM 3
scoreboard players set @a[distance=..5,scores={HUN_LVL_DAM=..3}] TIMER_HUN_DAM 800
scoreboard players set @a[distance=..5,scores={HAS_LVL_DAB=..2}] HAS_LVL_DAB 2
scoreboard players set @a[distance=..5,scores={HAS_LVL_DAB=..2}] TIMER_HAS_DAB 800
scoreboard players set @a[distance=..5,scores={SPD_LVL_DAB=..1}] SPD_LVL_DAB 1
scoreboard players set @a[distance=..5,scores={SPD_LVL_DAB=..1}] TIMER_SPD_DAB 800
#effect other 
