...
##other players
execute at @s as @a[distance=..5] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run effect give @s minecraft:invisibility 28 0 true
execute at @s as @a[distance=..5] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run scoreboard players set @s[scores={HUN_LVL_DAM=..2}] HUN_LVL_DAM 2
execute at @s as @a[distance=..5] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run scoreboard players set @s[scores={HUN_LVL_DAM=..2}] TIMER_HUN_DAM 560
execute at @s as @a[distance=..5] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run scoreboard players set @s[scores={HAS_LVL_DAB=..1}] HAS_LVL_DAB 1
execute at @s as @a[distance=..5] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run scoreboard players set @s[scores={HAS_LVL_DAB=..1}] TIMER_HAS_DAB 560
execute at @s as @a[distance=..5] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run scoreboard players set @s[scores={SPD_LVL_DAB=..1}] SPD_LVL_DAB 1
execute at @s as @a[distance=..5] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run scoreboard players set @s[scores={SPD_LVL_DAB=..1}] TIMER_SPD_DAB 560
#effect other 
