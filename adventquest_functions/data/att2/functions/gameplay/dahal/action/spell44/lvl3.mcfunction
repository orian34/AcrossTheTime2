...
effect give @a[distance=..3] minecraft:invisibility 25 0 true
scoreboard players set @a[distance=..3,scores={HUN_LVL_DAM=..2}] HUN_LVL_DAM 2
scoreboard players set @a[distance=..3,scores={HUN_LVL_DAM=..2}] TIMER_HUN_DAM 500
scoreboard players set @a[distance=..3,scores={HAS_LVL_DAB=..2}] HAS_LVL_DAB 2
scoreboard players set @a[distance=..3,scores={HAS_LVL_DAB=..2}] TIMER_HAS_DAB 500
scoreboard players set @a[distance=..3,scores={SPD_LVL_DAB=..1}] SPD_LVL_DAB 1
scoreboard players set @a[distance=..3,scores={SPD_LVL_DAB=..1}] TIMER_SPD_DAB 500
#effect other 
