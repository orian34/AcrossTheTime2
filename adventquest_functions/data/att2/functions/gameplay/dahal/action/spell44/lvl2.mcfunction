...
effect give @a[distance=..2] minecraft:invisibility 20 0 true
scoreboard players set @a[distance=..2,scores={HUN_LVL_DAM=..1}] HUN_LVL_DAM 1
scoreboard players set @a[distance=..2,scores={HUN_LVL_DAM=..1}] TIMER_HUN_DAM 400
scoreboard players set @a[distance=..2,scores={HAS_LVL_DAB=..1}] HAS_LVL_DAB 1
scoreboard players set @a[distance=..2,scores={HAS_LVL_DAB=..1}] TIMER_HAS_DAB 400
scoreboard players set @a[distance=..2,scores={SPD_LVL_DAB=..1}] SPD_LVL_DAB 1
scoreboard players set @a[distance=..2,scores={SPD_LVL_DAB=..1}] TIMER_SPD_DAB 400
#effect other 
