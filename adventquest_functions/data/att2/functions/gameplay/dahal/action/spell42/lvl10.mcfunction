...
execute as @a[distance=..10] at @s run particle minecraft:dust 0.95 0.11 0.23 5.0 ~ ~1 ~ 1.0 0.1 1.0 0 20 normal
execute as @a[distance=..10] at @s run particle minecraft:crimson_spore ~ ~1 ~ 0.2 1 0.2 0 100 normal
effect give @a[distance=..10] minecraft:instant_health 1 8 true
scoreboard players set @s[scores={RES_LVL_DAB=..6}] RES_LVL_DAB 6
scoreboard players set @s[scores={RES_LVL_DAB=..6}] TIMER_RES_DAB 200
##other players
execute at @s as @a[distance=..10] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run effect give @s minecraft:instant_health 1 4 true
execute at @s as @a[distance=..10] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run scoreboard players set @s RES_LVL_DAB 3
execute at @s as @a[distance=..10] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run scoreboard players set @s TIMER_RES_DAB 100
#effect other 
