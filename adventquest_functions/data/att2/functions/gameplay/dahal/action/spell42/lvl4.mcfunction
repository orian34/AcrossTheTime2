...
execute as @a[distance=..4,scores={RES_LVL_DAB=..4}] run scoreboard players set @s RES_LVL_DAB 4
execute as @a[distance=..4,scores={RES_LVL_DAB=..4}] run scoreboard players set @s TIMER_RES_DAB 20
