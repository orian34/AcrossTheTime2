...
execute as @a[distance=..7] at @s run particle minecraft:dust 0.95 0.11 0.23 3.5 ~ ~1 ~ 0.4 0.1 0.4 0 14 normal
...
scoreboard players set @s[scores={RES_LVL_DAB=..5}] TIMER_RES_DAB 60
##other players
execute at @s as @a[distance=..7] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run effect give @s minecraft:instant_health 1 2 true
execute at @s as @a[distance=..7] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run scoreboard players set @s RES_LVL_DAB 2
execute at @s as @a[distance=..7] unless score @s NUMEROJOUEUR = @a[distance=..0,limit=1] NUMEROJOUEUR run scoreboard players set @s TIMER_RES_DAB 30
#effect other 
