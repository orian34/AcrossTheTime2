...
execute as @a[distance=..9,scores={RES_LVL_DAB=..5}] run scoreboard players set @s RES_LVL_DAB 5
execute as @a[distance=..9,scores={RES_LVL_DAB=..5}] run scoreboard players set @s TIMER_RES_DAB 100
