...
execute as @a[distance=..3,scores={RES_LVL_DAB=..3}] run scoreboard players set @s RES_LVL_DAB 3
execute as @a[distance=..3,scores={RES_LVL_DAB=..3}] run scoreboard players set @s TIMER_RES_DAB 20
