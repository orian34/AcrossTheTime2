...
scoreboard players set leg_armset SPELL31 17
...
kill @e[type=minecraft:item,predicate=att2_pre:test_item/leg_armset,predicate=!att2_pre:test_item/error,distance=..2,limit=1,sort=nearest]
