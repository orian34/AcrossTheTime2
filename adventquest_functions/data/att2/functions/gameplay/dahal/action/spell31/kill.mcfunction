...
execute if entity @s[scores={NUMEROJOUEUR=1}] if entity @e[scores={FOLLOW_PLAYER=1}] run scoreboard players set @s COOLDOWN31 200
execute if entity @s[scores={NUMEROJOUEUR=2}] if entity @e[scores={FOLLOW_PLAYER=2}] run scoreboard players set @s COOLDOWN31 200
execute if entity @s[scores={NUMEROJOUEUR=3}] if entity @e[scores={FOLLOW_PLAYER=3}] run scoreboard players set @s COOLDOWN31 200
execute if entity @s[scores={NUMEROJOUEUR=4}] if entity @e[scores={FOLLOW_PLAYER=4}] run scoreboard players set @s COOLDOWN31 200
execute if entity @s[scores={NUMEROJOUEUR=5}] if entity @e[scores={FOLLOW_PLAYER=5}] run scoreboard players set @s COOLDOWN31 200
