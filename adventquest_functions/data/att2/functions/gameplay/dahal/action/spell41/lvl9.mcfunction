...
execute as @a[distance=..9] at @s run particle minecraft:dust 0.64 0.74 1 5.2 ~ ~ ~ 1.5 1.5 1.5 0 18 normal @a[distance=1..]
scoreboard players set @a[distance=..9,scores={HER_LVL_DAB=..8}] HER_LVL_DAB 8
scoreboard players set @a[distance=..9,scores={HER_LVL_DAB=..8}] TIMER_HER_DAB 350
scoreboard players set @a[distance=..9,scores={SPD_LVL_DAM=..5}] SPD_LVL_DAM 5
scoreboard players set @a[distance=..9,scores={SPD_LVL_DAM=..5}] TIMER_SPD_DAM 350
#effect other 
