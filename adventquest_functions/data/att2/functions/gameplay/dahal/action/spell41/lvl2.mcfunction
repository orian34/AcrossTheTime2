...
scoreboard players set @a[distance=..2,scores={HER_LVL_DAB=..4}] HER_LVL_DAB 4
scoreboard players set @a[distance=..2,scores={HER_LVL_DAB=..4}] TIMER_HER_DAB 120
scoreboard players set @a[distance=..2,scores={SPD_LVL_DAM=..1}] SPD_LVL_DAM 1
scoreboard players set @a[distance=..2,scores={SPD_LVL_DAM=..1}] TIMER_SPD_DAM 120
#effect other 
