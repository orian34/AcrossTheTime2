...
execute if entity @s[scores={NUMEROJOUEUR=1}] unless entity @e[type=minecraft:mule,nbt={UUID:[I;0,799,0,111]}] run function att2:gameplay/dahal/action/spell20/summon/mule7_player1
...
execute if entity @s[scores={NUMEROJOUEUR=2}] unless entity @e[type=minecraft:mule,nbt={UUID:[I;0,815,0,111]}] run function att2:gameplay/dahal/action/spell20/summon/mule7_player2
...
execute if entity @s[scores={NUMEROJOUEUR=3}] unless entity @e[type=minecraft:mule,nbt={UUID:[I;0,831,0,111]}] run function att2:gameplay/dahal/action/spell20/summon/mule7_player3
...
execute if entity @s[scores={NUMEROJOUEUR=4}] unless entity @e[type=minecraft:mule,nbt={UUID:[I;0,847,0,111]}] run function att2:gameplay/dahal/action/spell20/summon/mule7_player4
...
execute if entity @s[scores={NUMEROJOUEUR=5}] unless entity @e[type=minecraft:mule,nbt={UUID:[I;0,863,0,111]}] run function att2:gameplay/dahal/action/spell20/summon/mule7_player5
