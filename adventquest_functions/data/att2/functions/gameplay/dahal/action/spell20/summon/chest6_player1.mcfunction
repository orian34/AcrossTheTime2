...
summon minecraft:chest_minecart ~ ~ ~ {CustomDisplayTile:1b,CustomNameVisible:1b,NoGravity:1b,CustomName:"\"Stock 1-6\"",UUID:[I;0,799,0,111],Tags:["invminecarts.invisible_minecart","spell20_chest","NewInvo","KeepOriginalData","chest6","own_player1"],Silent:1,Invulnerable:1,HasVisualFire:0}
...
##follow owner
scoreboard players operation @e[tag=NewInvo,tag=spell20_chest,tag=chest6,tag=own_player1,distance=..10,limit=1,sort=nearest] FOLLOW_PLAYER = @s NUMEROJOUEUR
