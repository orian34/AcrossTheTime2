...
##
execute as @s[scores={SPELL20_SLCT=1,DAHAL=40..,other_minecart=0}] at @s anchored eyes positioned ^ ^-0.5 ^1 run function att2:gameplay/dahal/action/spell20/lvl1
execute as @s[scores={SPELL20_SLCT=2,DAHAL=40..,other_minecart=0}] at @s anchored eyes positioned ^ ^-0.5 ^1 run function att2:gameplay/dahal/action/spell20/lvl2
execute as @s[scores={SPELL20_SLCT=3,DAHAL=40..,other_minecart=0}] at @s anchored eyes positioned ^ ^-0.5 ^1 run function att2:gameplay/dahal/action/spell20/lvl3
execute as @s[scores={SPELL20_SLCT=4,DAHAL=40..,other_minecart=0}] at @s anchored eyes positioned ^ ^-0.5 ^1 run function att2:gameplay/dahal/action/spell20/lvl4
execute as @s[scores={SPELL20_SLCT=5,DAHAL=40..,other_minecart=0}] at @s anchored eyes positioned ^ ^-0.5 ^1 run function att2:gameplay/dahal/action/spell20/lvl5
execute as @s[scores={SPELL20_SLCT=6,DAHAL=40..,other_minecart=0}] at @s anchored eyes positioned ^ ^-0.5 ^1 run function att2:gameplay/dahal/action/spell20/lvl6
execute as @s[scores={SPELL20_SLCT=7,DAHAL=40..,other_minecart=0}] at @s anchored eyes positioned ^ ^-0.5 ^1 run function att2:gameplay/dahal/action/spell20/lvl7
##name color
