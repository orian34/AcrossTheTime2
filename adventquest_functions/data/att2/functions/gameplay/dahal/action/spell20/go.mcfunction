...
##
execute as @s[scores={SPELL_SLCT=191,DAHAL=40..,other_minecart=0}] anchored feet at @s positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell20/lvl1
execute as @s[scores={SPELL_SLCT=192,DAHAL=40..,other_minecart=0}] anchored feet at @s positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell20/lvl2
execute as @s[scores={SPELL_SLCT=193,DAHAL=40..,other_minecart=0}] anchored feet at @s positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell20/lvl3
execute as @s[scores={SPELL_SLCT=194,DAHAL=40..,other_minecart=0}] anchored feet at @s positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell20/lvl4
execute as @s[scores={SPELL_SLCT=195,DAHAL=40..,other_minecart=0}] anchored feet at @s positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell20/lvl5
execute as @s[scores={SPELL_SLCT=196,DAHAL=40..,other_minecart=0}] anchored feet at @s positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell20/lvl6
execute as @s[scores={SPELL_SLCT=197,DAHAL=40..,other_minecart=0}] anchored feet at @s positioned ^ ^ ^ run function att2:gameplay/dahal/action/spell20/lvl7
##name color
