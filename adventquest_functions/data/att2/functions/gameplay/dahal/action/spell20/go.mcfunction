...
execute as @s[scores={SPELL_SLCT=191,DAHAL=40..}] anchored feet at @s positioned ^ ^-0.25 ^ run function att2:gameplay/dahal/action/spell20/lvl1
execute as @s[scores={SPELL_SLCT=192,DAHAL=40..}] anchored feet at @s positioned ^ ^-0.25 ^ run function att2:gameplay/dahal/action/spell20/lvl2
execute as @s[scores={SPELL_SLCT=193,DAHAL=40..}] anchored feet at @s positioned ^ ^-0.25 ^ run function att2:gameplay/dahal/action/spell20/lvl3
