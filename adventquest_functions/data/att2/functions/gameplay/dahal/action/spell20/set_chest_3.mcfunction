...
##
execute if entity @s[scores={NUMEROJOUEUR=1}] run tp @e[type=minecraft:chest_minecart,tag=!NewInvo,tag=own_player1] -5229 144 -6295
execute if entity @s[scores={NUMEROJOUEUR=2}] run tp @e[type=minecraft:chest_minecart,tag=!NewInvo,tag=own_player2] -5229 144 -6295
execute if entity @s[scores={NUMEROJOUEUR=3}] run tp @e[type=minecraft:chest_minecart,tag=!NewInvo,tag=own_player3] -5229 144 -6295
execute if entity @s[scores={NUMEROJOUEUR=4}] run tp @e[type=minecraft:chest_minecart,tag=!NewInvo,tag=own_player4] -5229 144 -6295
execute if entity @s[scores={NUMEROJOUEUR=5}] run tp @e[type=minecraft:chest_minecart,tag=!NewInvo,tag=own_player5] -5229 144 -6295
##
