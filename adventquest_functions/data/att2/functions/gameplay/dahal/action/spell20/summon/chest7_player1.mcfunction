...
##follow owner
scoreboard players operation @e[tag=spell20_chest,tag=chest7,tag=own_player1
...
##particle
execute as @e[type=minecraft:chest_minecart,tag=chest7,tag=own_player1,nbt={UUID:[I;0,799,0,127]}dahal/action/spell20/invoke