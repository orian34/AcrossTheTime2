...
scoreboard players add @s SPELL30_LVL 5
...
execute at @e[type=minecraft:armor_stand,tag=RecyclerSpell] run function att2:gameplay/dahal/action/spell30/validate/lvl10