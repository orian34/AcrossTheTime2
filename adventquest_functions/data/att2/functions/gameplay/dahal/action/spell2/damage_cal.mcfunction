...
scoreboard players set maxDG SPDG 275
...
scoreboard players operation enhancementBONUS SPDG = BonusPowerSpell2 ENHANCEMENT
scoreboard players operation enhancementBONUS SPDG *= 25 ENHANCEMENT
