...
execute if score @s[nbt={Inventory:[{tag:{Spell:"spell309"}}]}] SPELL30_SC matches 1 if entity @e[type=item,predicate=att2_pre:dahal/launcher/spell_30,predicate=att2_pre:dahal/pickup] run function att2:dialogs/gameplay/dahal/only_one
