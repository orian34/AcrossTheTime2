...
execute unless entity @s[nbt={Inventory:[{tag:{Spell:"spell10"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/launcher/spell_10,distance=..2,limit=1,sort=nearest]
