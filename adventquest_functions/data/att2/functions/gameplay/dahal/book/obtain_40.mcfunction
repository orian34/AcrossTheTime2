...
execute unless entity @s[nbt={Inventory:[{tag:{Spell:"spell40"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/launcher/spell_40,distance=..2,limit=1,sort=nearest]
