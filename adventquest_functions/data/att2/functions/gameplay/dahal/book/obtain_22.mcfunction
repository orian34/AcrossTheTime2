...
execute unless entity @s[nbt={Inventory:[{tag:{Spell:"spell22"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/launcher/spell_22,distance=..2,limit=1,sort=nearest]
