...
execute unless entity @s[nbt={Inventory:[{tag:{Spell:"spell21"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/launcher/spell_21,predicate=att2_pre:dahal/pickup,limit=1,sort=nearest]
