...
execute unless entity @s[nbt={Inventory:[{tag:{Spell:"spell26"}}]}] run kill @e[type=item,predicate=att2_pre:dahal/launcher/spell_26,distance=..2,limit=1,sort=nearest]
