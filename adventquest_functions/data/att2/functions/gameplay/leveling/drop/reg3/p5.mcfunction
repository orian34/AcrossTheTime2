...
execute as @s[scores={GAMELEVEL=35..39}] run data merge entity @s {DeathLootTable:"att2:entities/regular/reg3l5t8"}
execute as @s[scores={GAMELEVEL=40..44}] run data merge entity @s {DeathLootTable:"att2:entities/regular/reg3l5t9"}
execute as @s[scores={GAMELEVEL=45..49}] run data merge entity @s {DeathLootTable:"att2:entities/regular/reg3l5t10"}
execute as @s[scores={GAMELEVEL=50..54}] run data merge entity @s {DeathLootTable:"att2:entities/regular/reg3l5t11"}
execute as @s[scores={GAMELEVEL=55..59}] run data merge entity @s {DeathLootTable:"att2:entities/regular/reg3l5t12"}
execute as @s[scores={GAMELEVEL=60..64}] run data merge entity @s {DeathLootTable:"att2:entities/regular/reg3l5t13"}
execute as @s[scores={GAMELEVEL=65..}] run data merge entity @s {DeathLootTable:"att2:entities/regular/reg3l5t14"}