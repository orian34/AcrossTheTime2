...
advancement grant @a only att2_test:test_mobskilled/kill_tag/class_sc_18
scoreboard players set closestClass XPPROCESS 20
#test revoke
execute if score @s NUMEROJOUEUR matches 1 run advancement revoke @a only att2_test:test_mobskilled/kill_tag/class_sc_18
