...
advancement grant @a only att2_test:test_mobskilled/kill_tag/class_sc_7
scoreboard players set closestClass XPPROCESS 9
#test revoke
execute if score @s NUMEROJOUEUR matches 1 run advancement revoke @a only att2_test:test_mobskilled/kill_tag/class_sc_7
