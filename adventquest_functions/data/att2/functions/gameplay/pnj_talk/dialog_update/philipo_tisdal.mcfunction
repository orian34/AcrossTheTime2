...
execute as @a[distance=..7] if score philipo_tisdal_PNJ DIALOG matches 3..3 run function att2:dialogs/sidequest/sq23/philipo_tisdal/dialog_3
execute as @a[distance=..7] if score philipo_tisdal_PNJ DIALOG matches 2..2 run function att2:dialogs/sidequest/sq23/philipo_tisdal/dialog_2
execute as @a[distance=..7] if score philipo_tisdal_PNJ DIALOG matches 1..1 run function att2:dialogs/sidequest/sq23/philipo_tisdal/dialog_1
