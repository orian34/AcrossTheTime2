...
scoreboard players set intendant_joffrey_PNJ statDIALOG 1
#test entity dialog
...
execute as @p[distance=..7] if score intendant_joffrey_PNJ DIALOG matches 2..2 run function att2:dialogs/others/intendant_joffrey/dialog_2
