...
execute if score GolemBoss BILLGART matches 0.. in minecraft:the_end if entity @a[x=-1330,y=120,z=-550,dx=55,dy=60,dz=-55,gamemode=adventure,advancements={att2_test:test_boss/golem=true}] unless entity @e[x=-1330,y=120,z=-550,dx=55,dy=60,dz=-55,nbt={UUID:[I;0,155,0,155]}] run function att2:gameplay/boss/billgart/golem/victory
