...
execute if entity @a[scores={LUC_TOT=1..}] run function att2:summon/reg_3/kum_rewards
execute if entity @a[scores={LUC_TOT=2..}] run function att2:summon/reg_3/kum_rewards
execute if entity @a[scores={LUC_TOT=3..}] run function att2:summon/reg_3/kum_rewards
execute if entity @a[scores={LUC_TOT=4..}] run function att2:summon/reg_3/kum_rewards
execute if entity @a[scores={LUC_TOT=5..}] run function att2:summon/reg_3/kum_rewards
...
execute if score kum_m BOSS_TIME matches 0 if score kum_s BOSS_TIME matches ..15 if score level DIFFICULTY matches 1.. run advancement grant @a only att2:hunting/kum_master_timerecord
