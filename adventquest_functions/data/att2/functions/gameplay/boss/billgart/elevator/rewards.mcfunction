...
execute if entity @a[scores={LUC_TOT=1..}] run function att2:summon/reg_3/elevator_rewards
execute if entity @a[scores={LUC_TOT=2..}] run function att2:summon/reg_3/elevator_rewards
execute if entity @a[scores={LUC_TOT=3..}] run function att2:summon/reg_3/elevator_rewards
execute if entity @a[scores={LUC_TOT=4..}] run function att2:summon/reg_3/elevator_rewards
execute if entity @a[scores={LUC_TOT=5..}] run function att2:summon/reg_3/elevator_rewards
...
execute if score elevator_m BOSS_TIME matches ..2 if score level DIFFICULTY matches 0.. run function att2:summon/bat_boss_esc_rewards
execute if score elevator_m BOSS_TIME matches ..2 if score level DIFFICULTY matches 0.. run function att2:summon/bat_runes_abc_rewards_2
#boss time 3
...
execute if score elevator_m BOSS_TIME matches ..2 if score level DIFFICULTY matches 1.. run function att2:summon/bat_boss_esc_rewards
execute if score elevator_m BOSS_TIME matches ..2 if score level DIFFICULTY matches 1.. run function att2:summon/bat_runes_abc_rewards_3
