...
execute if score elevator_m BOSS_TIME matches ..2 if score level DIFFICULTY matches 1.. run function advancement grant @a only att2:hunting/elevator_master_timerecord
