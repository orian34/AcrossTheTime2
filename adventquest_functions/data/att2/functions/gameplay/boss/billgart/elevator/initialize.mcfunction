#################################################################
#Made by Adventquest											#
#Initialize boss Elevator    									#
#################################################################

scoreboard objectives add BILLGART dummy
scoreboard players set Elevator BILLGART -1
scoreboard players set Elevator_level BILLGART 1
scoreboard players set 3 BILLGART 3
scoreboard players set Elevator_steps BILLGART 0
scoreboard players set Elevator_pos BILLGART 0
...
scoreboard players set EnterArena BILLGART 0