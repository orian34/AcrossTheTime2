...
#boss time 3
execute if score asurok_m BOSS_TIME matches 0 if score asurok_s BOSS_TIME matches ..10 if score level DIFFICULTY matches 1.. run function att2:summon/bat_boss_esc_rewards
execute if score asurok_m BOSS_TIME matches 0 if score asurok_s BOSS_TIME matches ..10 if score level DIFFICULTY matches 1.. run function att2:summon/bat_boss_esc_rewards
execute if score asurok_m BOSS_TIME matches 0 if score asurok_s BOSS_TIME matches ..10 if score level DIFFICULTY matches 1.. run function att2:summon/bat_runes_abc_rewards_1
