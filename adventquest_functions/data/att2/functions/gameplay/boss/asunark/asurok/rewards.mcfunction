...
execute if score level DIFFICULTY matches 0.. run function att2:summon/reg_1/asurok_rewards
execute if score level DIFFICULTY matches 0.. run function att2:summon/reg_1/asurok_rewards
execute if score level DIFFICULTY matches 0.. run function att2:summon/reg_1/asurok_rewards
execute if score level DIFFICULTY matches 0.. run function att2:summon/reg_1/asurok_rewards
execute if score level DIFFICULTY matches 0.. run function att2:summon/reg_1/asurok_rewards
...
execute if score BonusLootBoss RUNE matches 4.. run function att2:summon/reg_1/asurok_rewards
execute if score BonusLootBoss RUNE matches 5.. run function att2:summon/reg_1/asurok_rewards
execute if score BonusLootBoss RUNE matches 6.. run function att2:summon/reg_1/asurok_rewards
execute if score BonusLootBoss RUNE matches 7.. run function att2:summon/reg_1/asurok_rewards
execute if score BonusLootBoss RUNE matches 8.. run function att2:summon/reg_1/asurok_rewards
execute if score BonusLootBoss RUNE matches 9.. run function att2:summon/reg_1/asurok_rewards
...
execute if entity @a[scores={LUC_TOT=6..}] run function att2:summon/reg_1/asurok_rewards
execute if entity @a[scores={LUC_TOT=8..}] run function att2:summon/reg_1/asurok_rewards
execute if entity @a[scores={LUC_TOT=10..}] run function att2:summon/reg_1/asurok_rewards
execute if entity @a[scores={LUC_TOT=12..}] run function att2:summon/reg_1/asurok_rewards
execute if entity @a[scores={LUC_TOT=14..}] run function att2:summon/reg_1/asurok_rewards
...
execute if score asurok_m BOSS_TIME matches 0 run function att2:summon/bat_runes_c_rewards
#boss time 2
