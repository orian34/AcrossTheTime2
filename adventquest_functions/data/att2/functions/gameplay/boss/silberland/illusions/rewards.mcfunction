...
execute if entity @a[scores={LUC_TOT=1..}] run function att2:summon/reg_1/illusions_rewards
execute if entity @a[scores={LUC_TOT=2..}] run function att2:summon/reg_1/illusions_rewards
execute if entity @a[scores={LUC_TOT=3..}] run function att2:summon/reg_1/illusions_rewards
execute if entity @a[scores={LUC_TOT=4..}] run function att2:summon/reg_1/illusions_rewards
execute if entity @a[scores={LUC_TOT=5..}] run function att2:summon/reg_1/illusions_rewards
...
execute if score illusions_m BOSS_TIME matches 0 if score illusions_s BOSS_TIME matches ..60 run function att2:summon/bat_runes_abc_rewards_1
#boss time 2
...
execute if score illusions_m BOSS_TIME matches 0 if score illusions_s BOSS_TIME matches ..40 if score level DIFFICULTY matches 0.. run function att2:summon/bat_boss_esc_rewards
execute if score illusions_m BOSS_TIME matches 0 if score illusions_s BOSS_TIME matches ..40 if score level DIFFICULTY matches 0.. run function att2:summon/bat_runes_abc_rewards_2
...
execute if score illusions_m BOSS_TIME matches 0 if score illusions_s BOSS_TIME matches ..20 if score level DIFFICULTY matches 1.. run function advancement grant @a only att2:hunting/illusions_master_timerecord
