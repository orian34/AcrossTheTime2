...
execute as 00000000-0000-027c-0000-00000000027c at @s run tp @s ~ -2 ~
execute as 00000000-0000-028c-0000-00000000028c at @s run tp @s ~ -2 ~
execute as 00000000-0000-029c-0000-00000000029c at @s run tp @s ~ -2 ~
