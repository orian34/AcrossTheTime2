...
execute if entity @a[scores={LUC_TOT=1..}] run function att2:summon/reg_2/rodmat_rewards
execute if entity @a[scores={LUC_TOT=2..}] run function att2:summon/reg_2/rodmat_rewards
execute if entity @a[scores={LUC_TOT=3..}] run function att2:summon/reg_2/rodmat_rewards
execute if entity @a[scores={LUC_TOT=4..}] run function att2:summon/reg_2/rodmat_rewards
execute if entity @a[scores={LUC_TOT=5..}] run function att2:summon/reg_2/rodmat_rewards
...
execute if score rodmat_m BOSS_TIME matches ..1 if score rodmat_s BOSS_TIME matches ..30 if score level DIFFICULTY matches 1.. run function advancement grant @a only att2:hunting/rodmat_master_timerecord