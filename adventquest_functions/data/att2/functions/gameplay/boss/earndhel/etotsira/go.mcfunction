...
execute if score Etotsira EARNDHEL matches 0.. if entity @a[x=30025,y=14,z=29931,dx=30,dy=5,dz=30,gamemode=adventure] store result bossbar minecraft:etotsira value run data get entity 00000000-0000-008c-0000-00000000008a Health
execute if score Etotsira EARNDHEL matches 0.. if entity @a[x=30025,y=14,z=29931,dx=30,dy=5,dz=30,gamemode=adventure] store result bossbar minecraft:etotsira max run data get entity 00000000-0000-008c-0000-00000000008a Attributes[{Name:"minecraft:generic.max_health"}].Base
