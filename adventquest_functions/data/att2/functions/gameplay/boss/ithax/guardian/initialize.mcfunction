#################################################################
#Made by Adventquest											#
#Initialize boss Guardian    									#
#################################################################

scoreboard objectives add ITHAX dummy
scoreboard players set 5 ITHAX 5
...
scoreboard players set Guardian_pos ITHAX 0
scoreboard players set Player_pos ITHAX 0
...
scoreboard players set EnterArena ITHAX 0