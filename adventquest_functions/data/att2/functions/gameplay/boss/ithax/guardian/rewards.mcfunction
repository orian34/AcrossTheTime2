...
execute if entity @a[scores={LUC_TOT=7..}] run function att2:summon/bat_boss_esc_rewards
...
execute if entity @a[scores={LUC_TOT=13..}] run function att2:summon/bat_runes_abc_rewards_1
