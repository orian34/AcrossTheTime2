...
execute if score BonusLootBoss RUNE matches 4.. run function att2:summon/reg_1/doom_rewards
execute if score BonusLootBoss RUNE matches 5.. run function att2:summon/reg_1/doom_rewards
execute if score BonusLootBoss RUNE matches 6.. run function att2:summon/reg_1/doom_rewards
execute if score BonusLootBoss RUNE matches 7.. run function att2:summon/reg_1/doom_rewards
execute if score BonusLootBoss RUNE matches 8.. run function att2:summon/reg_1/doom_rewards
execute if score BonusLootBoss RUNE matches 9.. run function att2:summon/reg_1/doom_rewards
execute if score BonusLootBoss RUNE matches 10.. run function att2:summon/reg_1/doom_rewards
...
#boss time 2
execute if score doom_m BOSS_TIME matches ..1 if score level DIFFICULTY matches 0.. run function att2:summon/bat_boss_esc_rewards
execute if score doom_m BOSS_TIME matches ..1 if score level DIFFICULTY matches 0.. run function att2:summon/bat_boss_esc_rewards
execute if score doom_m BOSS_TIME matches ..1 if score level DIFFICULTY matches 0.. run function att2:summon/bat_runes_abc_rewards_1
#boss time 3
execute if score doom_m BOSS_TIME matches 0 if score level DIFFICULTY matches 1.. run function att2:summon/bat_boss_esc_rewards
execute if score doom_m BOSS_TIME matches 0 if score level DIFFICULTY matches 1.. run function att2:summon/bat_boss_esc_rewards
execute if score doom_m BOSS_TIME matches 0 if score level DIFFICULTY matches 1.. run function att2:summon/bat_boss_esc_rewards
execute if score doom_m BOSS_TIME matches 0 if score level DIFFICULTY matches 1.. run function att2:summon/bat_runes_abc_rewards_2
