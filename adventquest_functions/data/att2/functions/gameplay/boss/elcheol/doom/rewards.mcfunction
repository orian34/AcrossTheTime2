...
execute if entity @a[scores={LUC_TOT=6..}] run function att2:summon/reg_1/doom_rewards
execute if entity @a[scores={LUC_TOT=8..}] run function att2:summon/reg_1/doom_rewards
execute if entity @a[scores={LUC_TOT=10..}] run function att2:summon/reg_1/doom_rewards
execute if entity @a[scores={LUC_TOT=12..}] run function att2:summon/reg_1/doom_rewards
execute if entity @a[scores={LUC_TOT=14..}] run function att2:summon/reg_1/doom_rewards
