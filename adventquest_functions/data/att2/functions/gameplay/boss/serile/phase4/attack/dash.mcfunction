...
execute if score Timer3 SERILE matches 40 run function att2:gameplay/boss/serile/phase4/attack/dash/malus_effect
...
execute if score Timer3 SERILE matches 60..72 at 00000000-0000-022b-0000-00000000022b as @a[distance=..2] run effect give @s minecraft:instant_damage 1 2 true
execute if score Timer3 SERILE matches 75 run scoreboard players set Dash SERILE 0
execute if score Timer3 SERILE matches 80 run function att2:gameplay/boss/serile/phase4/attack/dash/malus_effect
...
execute if score Timer3 SERILE matches 100..112 at 00000000-0000-022b-0000-00000000022b as @a[distance=..2] run effect give @s minecraft:instant_damage 1 3 true
...
execute if score Timer3 SERILE matches 120 run function att2:gameplay/boss/serile/phase4/attack/dash/malus_effect
...
execute if score Timer3 SERILE matches 140..152 at 00000000-0000-022b-0000-00000000022b as @a[distance=..2] run effect give @s minecraft:instant_damage 1 3 true
...
execute if score Timer3 SERILE matches 165 run function att2:gameplay/boss/serile/phase4/attack/dash/malus_effect
...
execute if score Timer3 SERILE matches 180..192 at 00000000-0000-022b-0000-00000000022b as @a[distance=..2] run effect give @s minecraft:instant_damage 1 3 true
...
execute if score Timer3 SERILE matches 206 run data merge entity 00000000-0000-022b-0000-00000000022b {Attributes:[{Name:generic.movement_speed,Base:0.32}]}
