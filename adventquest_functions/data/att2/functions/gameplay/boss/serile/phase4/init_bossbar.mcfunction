...
execute store result bossbar minecraft:timer max run data get entity 00000000-0000-022b-0000-00000000010b Attributes[{Name:"minecraft:generic.max_health"}].Base