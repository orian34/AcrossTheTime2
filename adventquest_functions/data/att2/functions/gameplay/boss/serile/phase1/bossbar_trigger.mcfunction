...
execute if score Sphere1 SERILE matches 1 store result bossbar minecraft:sphere1 max run data get entity 00000000-0000-022b-0000-00000000001b Attributes[{Name:"minecraft:generic.max_health"}].Base
...
execute if score Sphere2 SERILE matches 1 store result bossbar minecraft:sphere2 max run data get entity 00000000-0000-022b-0000-00000000002b Attributes[{Name:"minecraft:generic.max_health"}].Base
...
execute if score Sphere3 SERILE matches 1 store result bossbar minecraft:sphere3 max run data get entity 00000000-0000-022b-0000-00000000003b Attributes[{Name:"minecraft:generic.max_health"}].Base
...
execute if score Sphere4 SERILE matches 1 store result bossbar minecraft:sphere4 max run data get entity 00000000-0000-022b-0000-00000000004b Attributes[{Name:"minecraft:generic.max_health"}].Base
...
execute if score Sphere5 SERILE matches 1 store result bossbar minecraft:sphere5 max run data get entity 00000000-0000-022b-0000-00000000005b Attributes[{Name:"minecraft:generic.max_health"}].Base
...
execute if score Sphere6 SERILE matches 1 store result bossbar minecraft:sphere6 max run data get entity 00000000-0000-022b-0000-00000000006b Attributes[{Name:"minecraft:generic.max_health"}].Base
...
execute if score Sphere7 SERILE matches 1 store result bossbar minecraft:sphere7 max run data get entity 00000000-0000-022b-0000-00000000007b Attributes[{Name:"minecraft:generic.max_health"}].Base
...
execute if score Sphere8 SERILE matches 1 store result bossbar minecraft:sphere8 max run data get entity 00000000-0000-022b-0000-00000000008b Attributes[{Name:"minecraft:generic.max_health"}].Base
...
execute store result bossbar minecraft:sphere9 max run data get entity 00000000-0000-022b-0000-00000000009b Attributes[{Name:"minecraft:generic.max_health"}].Base
...
execute store result bossbar minecraft:serile max run data get entity 00000000-0000-022b-0000-00000000022b Attributes[{Name:"minecraft:generic.max_health"}].Base
