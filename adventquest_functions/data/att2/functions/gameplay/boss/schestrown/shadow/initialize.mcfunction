#################################################################
#Made by Adventquest											#
#Initialize boss Shadow    										#
#################################################################

scoreboard objectives add SQ38 dummy
scoreboard players set 4 SQ38 4
scoreboard players set Shadow SQ38 -1
scoreboard players set ShadowSound SQ38 0
scoreboard players set Shadow_pos SQ38 0
...
scoreboard players set EnterArena SQ38 0