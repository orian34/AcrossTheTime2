...
execute as @e[type=item,distance=..2,nbt={Item:{id:"minecraft:glow_ink_sac",tag:{display:{Name:"{\"text\":\"§a§oAméthyste\"}","Lore":["{\"text\":\"§a§oAmethyst\"}","{\"text\":\"§6+500 Chronotons\"}"]}}},PickupDelay:0s}] run function att2:gameplay/chronoton/ground/pick_amethyst
...
execute as @e[type=item,distance=..2,nbt={Item:{id:"minecraft:glow_ink_sac",tag:{Action:"dropped",display:{Name:"{\"text\":\"§a§oAméthyste\"}","Lore":["{\"text\":\"§a§oAmethyst dropped\"}","{\"text\":\"§6+500 Chronotons\"}"]}}},PickupDelay:0s}] run function att2:gameplay/chronoton/ground/pick_amethyst_dropped
