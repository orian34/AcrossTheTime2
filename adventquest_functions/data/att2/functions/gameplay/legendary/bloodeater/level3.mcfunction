#################################################################
#Made by Adventquest											#
#Apply level 3 effect for Blood-eater user             			#
#################################################################
...
execute at @e[type=!player,team=hostile,distance=..6,limit=1,sort=nearest] run particle minecraft:item minecraft:soul_sand ~ ~1 ~ 0.2 0.4 0.2 0.9 80 force @a
