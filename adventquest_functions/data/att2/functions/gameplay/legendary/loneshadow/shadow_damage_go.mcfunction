...
execute if entity @s[scores={SHADOW_TOTAL=2000..2999}] run function att2:gameplay/legendary/loneshadow/damage_dealt/lvl3
execute if entity @s[scores={SHADOW_TOTAL=3000..3999}] run function att2:gameplay/legendary/loneshadow/damage_dealt/lvl4
execute if entity @s[scores={SHADOW_TOTAL=4000..4999}] run function att2:gameplay/legendary/loneshadow/damage_dealt/lvl5
execute if entity @s[scores={SHADOW_TOTAL=5000..5999}] run function att2:gameplay/legendary/loneshadow/damage_dealt/lvl6
execute if entity @s[scores={SHADOW_TOTAL=6000..6999}] run function att2:gameplay/legendary/loneshadow/damage_dealt/lvl7
execute if entity @s[scores={SHADOW_TOTAL=7000..7999}] run function att2:gameplay/legendary/loneshadow/damage_dealt/lvl8
execute if entity @s[scores={SHADOW_TOTAL=8000..}] run function att2:gameplay/legendary/loneshadow/damage_dealt/lvl9
