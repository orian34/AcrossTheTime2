...
effect give @a[scores={STR_TOT=25..}] minecraft:strength 2 100 true
effect give @a[scores={STR_TOT=26..}] minecraft:strength 2 112 true
effect give @a[scores={STR_TOT=27..}] minecraft:strength 2 125 true
effect give @a[scores={STR_TOT=28..}] minecraft:strength 2 140 true
effect give @a[scores={STR_TOT=29..}] minecraft:strength 2 155 true
effect give @a[scores={STR_TOT=30..}] minecraft:strength 2 170 true
effect give @a[scores={STR_TOT=31..}] minecraft:strength 2 185 true
effect give @a[scores={STR_TOT=32..}] minecraft:strength 2 200 true
effect give @a[scores={STR_TOT=33..}] minecraft:strength 2 215 true
effect give @a[scores={STR_TOT=34..}] minecraft:strength 2 235 true
effect give @a[scores={STR_TOT=35..}] minecraft:strength 2 255 true