...
execute positioned 5000 130 -5030 if score Pool4_A1 ARENA matches -2 if score Pool4_A1_Choose ARENA matches -1 run particle minecraft:dust -0.2 -0.2 -0.2 5 ~ ~ ~ 1 0 1 0 10 normal
