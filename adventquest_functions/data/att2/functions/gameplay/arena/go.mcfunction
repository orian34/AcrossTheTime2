...
execute if score Tournament ARENA matches 3 positioned 5000 73.5 -4984 if score Tournament ARENA matches 0.. run function att2:gameplay/arena/portal_arena_exit_effect_go
