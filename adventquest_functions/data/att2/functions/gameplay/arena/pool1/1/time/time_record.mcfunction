...
scoreboard players operation pool1_1_rt BOSS_TIME = pool1_1_t BOSS_TIME
scoreboard players operation pool1_1_rs BOSS_TIME = pool1_1_s BOSS_TIME
scoreboard players operation pool1_1_rm BOSS_TIME = pool1_1_m BOSS_TIME
##record this time
