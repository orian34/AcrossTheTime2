...
scoreboard players set Pool0_A1_Choose ARENA -1
scoreboard players set Pool0_Timer1 ARENA 100
tp @a[x=5000,y=100,z=-5000,distance=..500,gamemode=adventure,tag=InArena] 5157 70 -4748
...
##boss_timer Start
function att2:gameplay/arena/pool0/1/time/start