...
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{Effect:"her1_spd_3"}}]}] run function att2:gameplay/equipment/effect/oh/her1_spd_3
...
execute as @s[nbt={SelectedItem:{tag:{Effect:"her1_res_1"}}}] run function att2:gameplay/equipment/effect/le/her1_res_1
...
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{Effect:"spd2_her1_luc1_str_1"}}]}] run function att2:gameplay/equipment/effect/oh/spd2_her1_luc1_str_1
...
execute as @s[nbt={SelectedItem:{tag:{Effect:"str1_has2_hun_3"}}}] run function att2:gameplay/equipment/effect/le/str1_has2_hun_3
...
execute as @s[nbt={SelectedItem:{tag:{Effect:"str1_res1_luc1_hun_2"}}}] run function att2:gameplay/equipment/effect/le/str1_res1_luc1_hun_2
