...
execute as @s[nbt={SelectedItem:{tag:{Effect:"has1_dar_1"}}}] run function att2:gameplay/equipment/effect/le/has1_dar_1
...
execute as @s[nbt={SelectedItem:{tag:{Effect:"spd2_str_1"}}}] run function att2:gameplay/equipment/effect/le/has_1spd2_str_1
