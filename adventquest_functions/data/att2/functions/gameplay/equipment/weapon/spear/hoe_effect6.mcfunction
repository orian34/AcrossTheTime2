...
scoreboard players set @s MOTIONY 25
...
#Particle
particle minecraft:enchanted_hit ~ ~0.5 ~ 0.2 0.25 0.2 0.4 25 normal
particle minecraft:crit ~ ~0.5 ~ 0.3 0.25 0.3 0.4 25 normal