...
execute if score total_item RUNE = runicwords_0 RUNE run function att2:items/runes/words/0_gal_org_inu
#1_fus_ra_jo
...
execute if score total_item RUNE = runicwords_1 RUNE run function att2:items/runes/words/1_fus_ra_jo
#2_nym_ehl_ave
...
execute if score total_item RUNE = runicwords_2 RUNE run function att2:items/runes/words/2_nym_ehl_ave
#3_for_tha_gal_hal
...
execute if score total_item RUNE = runicwords_3 RUNE run function att2:items/runes/words/3_for_tha_gal_hal
#4_inu_von_ust
...
execute if score total_item RUNE = runicwords_4 RUNE run function att2:items/runes/words/4_inu_von_ust
#5_jo_fus_nym_da
...
execute if score total_item RUNE = runicwords_5 RUNE run function att2:items/runes/words/5_jo_fus_nym_da
#6_ehl_hal_ra_ra
...
execute if score ra RUNE matches 1 run scoreboard players operation runicwords_6 RUNE += ra RUNE
execute if score total_item RUNE = runicwords_6 RUNE run function att2:items/runes/words/6_ehl_hal_ra_ra
#7_wej_ust_chu_tha
...
execute if score total_item RUNE = runicwords_7 RUNE run function att2:items/runes/words/7_wej_ust_chu_tha
...
execute if score total_item RUNE = runicwords_8 RUNE run function att2:items/runes/words/8_org_ave_hal_gal_ehl
#9_da_for_inu
...
execute if score total_item RUNE = runicwords_9 RUNE run function att2:items/runes/words/9_da_for_inu
#10_chu_lya_ehl
...
execute if score total_item RUNE = runicwords_10 RUNE run function att2:items/runes/words/10_chu_lya_ehl
#11_lya_nym_fus_von
...
execute if score total_item RUNE = runicwords_11 RUNE run function att2:items/runes/words/11_lya_nym_fus_von
...
execute if score total_item RUNE = runicwords_12 RUNE run function att2:items/runes/words/12_ave_qi_gal_jo_wej
#13_tha_bex_for
...
execute if score total_item RUNE = runicwords_13 RUNE run function att2:items/runes/words/13_tha_bex_for
#14_puh_wej_von_org
...
execute if score total_item RUNE = runicwords_14 RUNE run function att2:items/runes/words/14_puh_wej_von_org
#15_syl_da_ave_qi_ra
...
execute if score total_item RUNE = runicwords_15 RUNE run function att2:items/runes/words/15_syl_da_ave_qi_ra
#16_von_yog_yog
execute if score von RUNE matches 1 run scoreboard players operation runicwords_16 RUNE += von RUNE
execute if score yog RUNE matches 1 run scoreboard players operation runicwords_16 RUNE += yog RUNE
execute if score total_item RUNE = runicwords_16 RUNE run function att2:items/runes/words/16_von_yog_yog
#17_kan_chu_bex_puh
...
execute if score total_item RUNE = runicwords_17 RUNE run function att2:items/runes/words/17_kan_chu_bex_puh
...
execute if score total_item RUNE = runicwords_18 RUNE run function att2:items/runes/words/18_ust_xul_lya_zen_da
...
execute if score total_item RUNE = runicwords_19 RUNE run function att2:items/runes/words/19_mot_syl_kan_xul_zen
...
execute if score total_item RUNE = runicwords_20 RUNE run function att2:gameplay/runes/bonus/20_bex_lya_qi_wej_yog
...
execute if score total_item RUNE = runicwords_21 RUNE run function att2:gameplay/runes/bonus/21_hal_kan_puh_syl_chu