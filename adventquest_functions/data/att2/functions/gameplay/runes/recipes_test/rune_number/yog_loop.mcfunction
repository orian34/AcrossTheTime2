...
execute if score yog RUNE matches 2 if score esc RUNE matches ..2 run function att2:items/runes/22_yog
execute if score yog RUNE matches 2 if score esc RUNE matches ..2 run scoreboard players remove yog RUNE 1
#over
