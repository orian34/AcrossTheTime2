...
#back zen
execute if score zen RUNE matches 1.. if score esc RUNE matches ..2 run function att2:items/runes/25_zen
execute if score zen RUNE matches 1.. if score esc RUNE matches ..2 run scoreboard players remove zen RUNE 1
#over
