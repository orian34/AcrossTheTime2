...
#back Qi
execute if score qi RUNE matches 1.. if score esc RUNE matches 0 run function att2:items/runes/18_qi
execute if score qi RUNE matches 1.. if score esc RUNE matches 0 run scoreboard players remove qi RUNE 1
#over
