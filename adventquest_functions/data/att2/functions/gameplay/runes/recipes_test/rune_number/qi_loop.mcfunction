...
execute if score qi RUNE matches 2 if score esc RUNE matches ..2 run function att2:items/runes/18_qi
execute if score qi RUNE matches 2 if score esc RUNE matches ..2 run scoreboard players remove qi RUNE 1
#over
