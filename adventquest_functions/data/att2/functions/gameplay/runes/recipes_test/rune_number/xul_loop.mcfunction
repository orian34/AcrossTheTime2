...
#back Xul
execute if score xul RUNE matches 1.. if score esc RUNE matches ..2 run function att2:items/runes/24_xul
execute if score xul RUNE matches 1.. if score esc RUNE matches ..2 run scoreboard players remove xul RUNE 1
#over
