...
execute if score bex RUNE matches 1.. if score esc RUNE matches 0 run function att2:items/runes/19_bex
execute if score bex RUNE matches 1.. if score esc RUNE matches 0 run scoreboard players remove bex RUNE 1
#over
