...
##Puh 2..
execute if score puh RUNE matches 2.. if score esc RUNE matches 1.. run function att2:items/runes/21_syl
execute if score puh RUNE matches 2.. if score esc RUNE matches 1.. run function att2:gameplay/runes/recipes_test/rune_number/puh_reduce
#back esc
...
#loop
execute if score puh RUNE matches 1.. run function att2:gameplay/runes/recipes_test/rune_number/puh_loop
execute if score puh RUNE matches 0 if score esc RUNE matches 1.. run function att2:gameplay/runes/recipes_test/rune_number/puh_loop
