...
execute if score total_item RUNE = 7ESC RUNE if score 7ESC RUNE matches 5 run function att2:items/chronoton/esc_7
#item->2 ESC
...
execute if score total_item RUNE = 2ESC RUNE if score 7ESC RUNE matches 4 run function att2:items/chronoton/esc_2
#500 XP
...
execute if score total_item RUNE = ev_potion RUNE if score ev_potion RUNE matches 5 run function att2:gameplay/legendary/elixirvitae/obtain
#Kinuil
execute if score total_item RUNE = kinuil RUNE run function att2:summon/bat_runes_kinuil_rewards
