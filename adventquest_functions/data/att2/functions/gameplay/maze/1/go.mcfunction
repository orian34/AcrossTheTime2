...
execute if score Timer MAZE matches 1.. as @e[type=minecraft:wither_skeleton,x=-10051,y=65,z=-10005,dx=97,dy=15,dz=-74] at @s run function att2:gameplay/maze/elites_effect
...
execute if score Timer MAZE matches 1.. run function att2:gameplay/maze/1/symbol
