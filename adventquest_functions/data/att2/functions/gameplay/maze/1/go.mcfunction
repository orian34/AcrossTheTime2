...
execute if score Timer MAZE matches 1.. as @e[type=minecraft:wither_skeleton,tag=MazeMinion,x=-10051,y=74,z=-10005,dx=97,dy=5,dz=-74,limit=1] run function att2:gameplay/maze/1/minions_spread
execute if score Timer MAZE matches 1.. as @e[type=minecraft:wither_skeleton,tag=MazeMinion,x=-10051,y=71,z=-10005,dx=97,dy=2,dz=-74] at @s run function att2:gameplay/maze/minions_effect
