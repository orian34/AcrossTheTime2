...
execute if score Timer MAZE matches 1.. as @e[type=minecraft:wither_skeleton,x=-9947,y=65,z=-10085,dx=248,dy=15,dz=205] at @s run function att2:gameplay/maze/elites_effect
...
execute if score Timer MAZE matches 1.. run function att2:gameplay/maze/5/symbol
