...
execute if score stock RUNE_POWDER matches 25.. run function att2:gameplay/maze/2/loading
execute if score stock RUNE_POWDER matches 25.. run scoreboard players set difficulty MAZE 1
