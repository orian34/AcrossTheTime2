...
execute if score Timer MAZE matches 1.. as @e[type=minecraft:wither_skeleton,x=-10086,y=65,z=-10095,dx=154,dy=15,dz=-85] at @s run function att2:gameplay/maze/elites_effect
