...
execute if score Timer MAZE matches 1.. as @e[type=minecraft:wither_skeleton,x=-9416,y=65,z=-10179,dx=-296,dy=15,dz=-260] at @s run function att2:gameplay/maze/elites_effect
...
execute if score Timer MAZE matches 1.. run function att2:gameplay/maze/7/symbol
