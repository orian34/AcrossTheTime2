...
tp @s -9867 71 -10239
execute as @a[x=-10094,y=71,z=-10196,dx=225,dy=7,dz=-91,gamemode=adventure] at @s run tp @s -9867 71 -10239
...
execute as @e[type=minecraft:chest_minecart,tag=maze_chest,x=-10094,y=71,z=-10196,dx=225,dy=7,dz=-91] run tp @s ~ 0 ~
