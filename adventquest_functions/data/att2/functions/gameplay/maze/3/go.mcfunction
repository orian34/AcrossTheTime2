...
execute if score Timer MAZE matches 1.. as @e[type=minecraft:wither_skeleton,x=-10094,y=65,z=-10196,dx=225,dy=15,dz=-91] at @s run function att2:gameplay/maze/elites_effect
...
execute if score Timer MAZE matches 1.. run function att2:gameplay/maze/3/symbol
