...
execute if score stock RUNE_POWDER matches 40.. run function att2:gameplay/maze/3/loading
execute if score stock RUNE_POWDER matches 40.. run scoreboard players set difficulty MAZE 1
