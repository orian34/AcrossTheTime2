...
execute if score Timer MAZE matches 1.. as @e[type=minecraft:wither_skeleton,tag=MazeMinion,x=-9722,y=79,z=-10329,dx=-195,dy=6,dz=228,limit=1] if entity @s run function att2:gameplay/maze/4/minions_spread
execute if score Timer MAZE matches 1.. as @e[type=minecraft:wither_skeleton,tag=MazeMinion,x=-9722,y=71,z=-10329,dx=-195,dy=5,dz=228,limit=1] at @s run function att2:gameplay/maze/minions_effect
