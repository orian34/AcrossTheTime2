...
tp @s -9569 71 -10165
execute as @a[x=-9683,y=71,z=-9866,dx=204,dy=7,dz=-297,gamemode=adventure] at @s run tp @s -9569 71 -10165
...
execute as @e[type=minecraft:chest_minecart,tag=maze_chest,x=-9683,y=71,z=-9866,dx=204,dy=7,dz=-297] run tp @s ~ 0 ~
