...
execute if score Timer MAZE matches 1.. as @e[type=minecraft:wither_skeleton,x=-9683,y=65,z=-9866,dx=204,dy=15,dz=-297] at @s run function att2:gameplay/maze/elites_effect
...
execute if score Timer MAZE matches 1.. run function att2:gameplay/maze/6/symbol
