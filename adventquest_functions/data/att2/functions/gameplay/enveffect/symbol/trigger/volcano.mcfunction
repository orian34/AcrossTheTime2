...
### Volcano
#0
execute in minecraft:overworld positioned -5481 86 -5145 if block ~ ~ ~ minecraft:light run function att2:gameplay/enveffect/symbol/detection/volcano
execute in minecraft:overworld positioned -5588 78 -5164 if block ~ ~ ~ minecraft:light run function att2:gameplay/enveffect/symbol/detection/volcano
execute in minecraft:overworld positioned -5531 79 -5278 if block ~ ~ ~ minecraft:light run function att2:gameplay/enveffect/symbol/detection/volcano
execute in minecraft:overworld positioned -5439 72 -5481 if block ~ ~ ~ minecraft:light run function att2:gameplay/enveffect/symbol/detection/volcano
execute in minecraft:overworld positioned -5390 82 -5586 if block ~ ~ ~ minecraft:light run function att2:gameplay/enveffect/symbol/detection/volcano
execute in minecraft:overworld positioned -5487 97 -5574 if block ~ ~ ~ minecraft:light run function att2:gameplay/enveffect/symbol/detection/volcano
