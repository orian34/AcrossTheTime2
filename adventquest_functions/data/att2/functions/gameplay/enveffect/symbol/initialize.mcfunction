...
scoreboard players set Angband_road SYMBOL 0
scoreboard players set Angor_north SYMBOL 0
scoreboard players set Angor_palace SYMBOL 0
scoreboard players set Angor_south SYMBOL 0
scoreboard players set Asunark SYMBOL 0
scoreboard players set Beach SYMBOL 0
scoreboard players set Billgart_dungeon SYMBOL 0
scoreboard players set Billgart_road SYMBOL 0
...
scoreboard players set Exiles_camp SYMBOL 0
...
scoreboard players set Ouranos_road SYMBOL 0
scoreboard players set Ouranos_tower SYMBOL 0
scoreboard players set Phoenix SYMBOL 0
