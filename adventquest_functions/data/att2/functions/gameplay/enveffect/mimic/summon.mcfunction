...
summon minecraft:slime ~ ~2 ~ {Tags:["New","MIMIC","LVL0","PlayerAlly"],DeathLootTable:"att2:empty",Size:1,Silent:1,Invulnerable:1,active_effects:[{id:invisibility,amplifier:1,duration:-1,show_particles:0b},{id:fire_resistance,amplifier:0,duration:-1,show_particles:0b},{id:resistance,amplifier:4,duration:-1,show_particles:0b}],Attributes:[{Name:generic.max_health,Base:50}],Health:50,Passengers:[{id:"minecraft:item_display",item:{id:"minecraft:chest",Count:1b},Tags:["MIMIC","New","PlayerAlly"],item_display:"head",transformation:{translation:[0f,-0.45f,0f],scale:[1f,1f,1f]}}]}
#set scale value
data merge entity @e[tag=MIMIC,type=item_display,limit=1] {transformation:{translation:[0f,-0.45f,0f],scale:[1f,1f,1f]},glow_color_override:-1,Glowing:1}
#set DIMENSION->LOOT
