...
execute if score 1RNG10 RNG matches 1..5 run function att2:summon/reg_1/skeletonarcher1_class2
execute if score 1RNG10 RNG matches 1..4 run function att2:summon/reg_1/skeletonarcher2_class2
execute if score 1RNG10 RNG matches 1..3 run function att2:summon/reg_1/zombie4_class3
execute if score 1RNG10 RNG matches 1..2 run function att2:summon/reg_1/skeletonarcher3_class3
execute if score 1RNG10 RNG matches 1 run function att2:summon/reg_1/skeletonarcher4_class4