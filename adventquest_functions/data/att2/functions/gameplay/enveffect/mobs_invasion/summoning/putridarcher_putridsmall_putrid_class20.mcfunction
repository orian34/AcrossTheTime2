...
execute if score RNG10 RNG10_Variable matches 0..10 run function att2:summon/reg_1/putridarcher0_class14
execute if score RNG10 RNG10_Variable matches 0..10 run function att2:summon/reg_1/putridarcher1_class14
...
execute if score RNG10 RNG10_Variable matches 0..7 run function att2:summon/reg_1/putridsmall1_class18
execute if score RNG10 RNG10_Variable matches 0..6 run function att2:summon/reg_1/putridsmall2_class18
execute if score RNG10 RNG10_Variable matches 0..5 run function att2:summon/reg_1/putridarcher2_class18
execute if score RNG10 RNG10_Variable matches 0..4 run function att2:summon/reg_1/putridarcher3_class18
execute if score RNG10 RNG10_Variable matches 0..3 run function att2:summon/reg_1/putrid4_class19
