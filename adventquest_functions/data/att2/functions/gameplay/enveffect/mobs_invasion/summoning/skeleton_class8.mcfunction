...
execute if score 1RNG10 RNG matches 1..10 run function att2:summon/reg_1/skeleton4_class5
execute if score 1RNG10 RNG matches 1..9 run function att2:summon/reg_1/skeleton5_class5
execute if score 1RNG10 RNG matches 1..8 run function att2:summon/reg_1/skeleton5_class5
execute if score 1RNG10 RNG matches 1..7 run function att2:summon/reg_1/skeleton5_class6
execute if score 1RNG10 RNG matches 1..6 run function att2:summon/reg_1/skeleton5_class6
execute if score 1RNG10 RNG matches 1..5 run function att2:summon/reg_1/skeleton6_class6
execute if score 1RNG10 RNG matches 1..4 run function att2:summon/reg_1/skeleton6_class6
execute if score 1RNG10 RNG matches 1..3 run function att2:summon/reg_1/skeleton7_class7
