...
execute if score RNG10 RNG10_Variable matches 0..10 run function att2:summon/reg_1/creeper2_class13
execute if score RNG10 RNG10_Variable matches 0..9 run function att2:summon/reg_1/creeper0_class14
execute if score RNG10 RNG10_Variable matches 0..8 run function att2:summon/reg_1/creeper1_class14
...
execute if score RNG10 RNG10_Variable matches 0..5 run function att2:summon/reg_1/husk1_class17
execute if score RNG10 RNG10_Variable matches 0..4 run function att2:summon/reg_1/creeper3_class17
execute if score RNG10 RNG10_Variable matches 0..3 run function att2:summon/reg_1/creeper4_class18
