...
execute if score 1RNG10 RNG matches 1..10 run function att2:summon/reg_1/creeper0_class13
execute if score 1RNG10 RNG matches 1..10 run function att2:summon/reg_1/creeper2_class13
execute if score 1RNG10 RNG matches 1..9 run function att2:summon/reg_1/creeper0_class14
execute if score 1RNG10 RNG matches 1..8 run function att2:summon/reg_1/creeper1_class14
...
execute if score 1RNG10 RNG matches 1..5 run function att2:summon/reg_1/husk1_class17
execute if score 1RNG10 RNG matches 1..4 run function att2:summon/reg_1/creeper3_class17
execute if score 1RNG10 RNG matches 1..3 run function att2:summon/reg_1/creeper4_class18
