...
execute if score numberPlayer COUNT matches 1 if score 1RNG100 RNG matches 25..75 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position
execute if score numberPlayer COUNT matches 2 if score 1RNG100 RNG matches 20..80 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position
execute if score numberPlayer COUNT matches 3 if score 1RNG100 RNG matches 15..85 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position
execute if score numberPlayer COUNT matches 4 if score 1RNG100 RNG matches 10..90 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position
execute if score numberPlayer COUNT matches 5.. if score 1RNG100 RNG matches 5..95 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position