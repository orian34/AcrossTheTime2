...
execute if score numberPlayer COUNT matches 1 if score RNG100 RNG100_Variable matches 23..77 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position
execute if score numberPlayer COUNT matches 2 if score RNG100 RNG100_Variable matches 18..82 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position
execute if score numberPlayer COUNT matches 3 if score RNG100 RNG100_Variable matches 13..87 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position
execute if score numberPlayer COUNT matches 4 if score RNG100 RNG100_Variable matches 8..92 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position
execute if score numberPlayer COUNT matches 5.. if score RNG100 RNG100_Variable matches 3..97 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position