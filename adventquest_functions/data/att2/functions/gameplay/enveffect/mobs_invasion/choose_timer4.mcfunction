...
execute if score numberPlayer COUNT matches 1 if score 1RNG100 RNG matches 24..76 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position
execute if score numberPlayer COUNT matches 2 if score 1RNG100 RNG matches 19..81 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position
execute if score numberPlayer COUNT matches 3 if score 1RNG100 RNG matches 14..86 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position
execute if score numberPlayer COUNT matches 4 if score 1RNG100 RNG matches 9..91 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position
execute if score numberPlayer COUNT matches 5.. if score 1RNG100 RNG matches 4..96 run function att2:gameplay/enveffect/mobs_invasion/summon_trigger_position