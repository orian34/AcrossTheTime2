...
execute as @p[scores={GAMELEVEL=0..}] run function att2:summon/chronoton/diamond
execute as @p[scores={GAMELEVEL=25..}] run function att2:summon/chronoton/diamond
execute as @p[scores={GAMELEVEL=25..}] at @s run function att2:summon/chronoton/esc
execute as @p[scores={GAMELEVEL=50..}] run function att2:summon/chronoton/diamond
execute as @p[scores={GAMELEVEL=50..}] at @s run function att2:summon/chronoton/esc
execute as @p[scores={LEVELMASTER=25..}] run function att2:summon/chronoton/diamond
execute as @p[scores={LEVELMASTER=25..}] at @s run function att2:summon/chronoton/esc
