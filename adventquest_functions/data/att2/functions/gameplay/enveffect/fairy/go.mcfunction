...
execute if score Fairy TIMER matches ..0 if score active MAZE matches 1 as @p[scores={DIMENSION=-3},x=-9800,y=70,z=-10100] run function att2:gameplay/enveffect/fairy/choose_timer