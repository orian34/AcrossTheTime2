...
scoreboard players operation 5_jo GRINDER *= 2 GRINDER
scoreboard players operation 6_ra GRINDER *= 2 GRINDER
scoreboard players operation 7_nym GRINDER *= 3 GRINDER
scoreboard players operation 8_inu GRINDER *= 4 GRINDER
scoreboard players operation 9_hal GRINDER *= 5 GRINDER
scoreboard players operation 10_von GRINDER *= 20 GRINDER
scoreboard players operation 11_ehl GRINDER *= 20 GRINDER
scoreboard players operation 12_ave GRINDER *= 20 GRINDER
scoreboard players operation 13_chu GRINDER *= 20 GRINDER
scoreboard players operation 14_for GRINDER *= 20 GRINDER
scoreboard players operation 15_da GRINDER *= 40 GRINDER
scoreboard players operation 16_wej GRINDER *= 40 GRINDER
scoreboard players operation 17_ust GRINDER *= 40 GRINDER
scoreboard players operation 18_lya GRINDER *= 40 GRINDER
scoreboard players operation 19_qi GRINDER *= 75 GRINDER
scoreboard players operation 20_bex GRINDER *= 75 GRINDER
scoreboard players operation 21_puh GRINDER *= 100 GRINDER
scoreboard players operation 22_syl GRINDER *= 100 GRINDER
scoreboard players operation 23_yog GRINDER *= 250 GRINDER
scoreboard players operation 24_kan GRINDER *= 250 GRINDER
scoreboard players operation 25_xul GRINDER *= 500 GRINDER
scoreboard players operation 26_zen GRINDER *= 500 GRINDER
scoreboard players operation 27_mot GRINDER *= 1000 GRINDER
