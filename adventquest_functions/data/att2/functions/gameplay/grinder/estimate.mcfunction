...
scoreboard players operation 2_tha GRINDER *= 2 GRINDER
scoreboard players operation 3_fus GRINDER *= 3 GRINDER
scoreboard players operation 4_org GRINDER *= 4 GRINDER
scoreboard players operation 5_jo GRINDER *= 5 GRINDER
scoreboard players operation 6_ra GRINDER *= 6 GRINDER
scoreboard players operation 7_nym GRINDER *= 7 GRINDER
scoreboard players operation 8_inu GRINDER *= 8 GRINDER
scoreboard players operation 9_hal GRINDER *= 9 GRINDER
scoreboard players operation 10_von GRINDER *= 10 GRINDER
scoreboard players operation 11_ehl GRINDER *= 12 GRINDER
scoreboard players operation 12_ave GRINDER *= 14 GRINDER
scoreboard players operation 13_chu GRINDER *= 17 GRINDER
scoreboard players operation 14_for GRINDER *= 20 GRINDER
scoreboard players operation 15_da GRINDER *= 24 GRINDER
scoreboard players operation 16_wej GRINDER *= 28 GRINDER
scoreboard players operation 17_ust GRINDER *= 34 GRINDER
scoreboard players operation 18_lya GRINDER *= 39 GRINDER
scoreboard players operation 19_qi GRINDER *= 44 GRINDER
scoreboard players operation 20_bex GRINDER *= 50 GRINDER
scoreboard players operation 21_puh GRINDER *= 57 GRINDER
scoreboard players operation 22_syl GRINDER *= 65 GRINDER
scoreboard players operation 23_yog GRINDER *= 75 GRINDER
scoreboard players operation 24_kan GRINDER *= 100 GRINDER
scoreboard players operation 25_xul GRINDER *= 150 GRINDER
