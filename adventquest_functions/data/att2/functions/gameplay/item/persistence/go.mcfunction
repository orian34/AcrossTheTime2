...
execute if score tic TIMECOUNTER matches 5 at @e[type=minecraft:armor_stand,tag=Recycler,limit=1] as @e[type=minecraft:item,distance=..2] run data merge entity @s {Age:-32767s}