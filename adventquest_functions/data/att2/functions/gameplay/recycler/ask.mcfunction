...
execute at @e[tag=Recycler,sort=nearest,limit=1] if score total RECYCLER matches 0 if score number RECYCLER matches 0 run function att2:dialogs/gameplay/shop/buyer/level_info
