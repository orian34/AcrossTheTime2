...
execute as @a at @s positioned ^ ^ ^3.5 as @e[team=hostile,distance=..3,scores={GAMELEVEL=0..}] at @s store result bossbar healthbar max run data get entity @s Attributes[{Name:"minecraft:generic.max_health"}].Base
