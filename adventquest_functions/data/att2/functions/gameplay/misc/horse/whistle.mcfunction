...
execute if score @s HORSE matches 0 unless entity @e[type=minecraft:horse,tag=NewInvo,distance=..4,scores={tp_spell32_timer=..0}] run function att2:gameplay/misc/horse/no_horse
