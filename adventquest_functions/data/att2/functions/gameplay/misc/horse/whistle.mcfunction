...
execute if score @s HORSE matches 1 run function att2:gameplay/misc/horse/call_back
execute if score @s HORSE matches 0 if entity @e[type=minecraft:horse,distance=..3] run function att2:gameplay/misc/horse/transfer
execute if score @s HORSE matches 0..1 run scoreboard players add @s HORSE 1
