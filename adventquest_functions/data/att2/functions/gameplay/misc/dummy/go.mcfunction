...
execute if entity @a[x=-4979,y=76,z=-5063,dx=13,dy=4,dz=8,gamemode=adventure] store result bossbar minecraft:irongolem max run data get entity @e[type=minecraft:iron_golem,tag=Dummy,limit=1] Attributes[{Name:"minecraft:generic.max_health"}].Base
...
execute if entity @a[x=-4979,y=76,z=-5063,dx=13,dy=4,dz=8,gamemode=adventure] store result bossbar minecraft:undead max run data get entity @e[type=minecraft:husk,tag=Dummy,limit=1] Attributes[{Name:"minecraft:generic.max_health"}].Base
