...
#exploit_book
execute if score minute TIMECOUNTER matches 0 if score second TIMECOUNTER matches 0 as @a run function att2:gameplay/misc/exploit_book/go with storage exploit_book