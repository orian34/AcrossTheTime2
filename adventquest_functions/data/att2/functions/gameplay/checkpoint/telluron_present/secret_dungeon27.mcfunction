...
execute in minecraft:overworld run spawnpoint @a -5402 136 -5854

execute if score Secret_dungeon27 CHECKPOINT matches 0 run scoreboard players add All CHECKPOINT 1
##test all checkpoint
...
scoreboard players set Secret_dungeon27 CHECKPOINT 1