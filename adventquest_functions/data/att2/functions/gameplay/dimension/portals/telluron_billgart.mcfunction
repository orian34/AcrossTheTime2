...
execute in minecraft:overworld as @e[x=-3179,y=126,z=4902,dx=5,dy=5,dz=0] in minecraft:the_end run function att2:gameplay/dimension/portals/tp_to_billgart
