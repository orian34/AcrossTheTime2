...
execute in minecraft:overworld if block 6992 138 6360 minecraft:oak_button positioned 6922 140 6360 run function att2:gameplay/quest/mainquest/show_secondary_objective
