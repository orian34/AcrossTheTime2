...
execute if entity @s[scores={DIMENSION=1}] in minecraft:overworld positioned -5916 117 -4360 run function att2:gameplay/gps/summon_arrow
...
execute in minecraft:overworld positioned -7408 116 -4399 run function att2:gameplay/quest/mainquest/show_secondary_objective