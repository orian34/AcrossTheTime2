...
execute in minecraft:the_end positioned -1339 129 -693 run function att2:gameplay/quest/mainquest/show_secondary_objective
execute in minecraft:the_end positioned -1292 104 -636 run function att2:gameplay/quest/mainquest/show_secondary_objective
