...
execute in minecraft:the_end if block -1324 25 -674 minecraft:stone_button positioned -1323 26 -674 run function att2:gameplay/quest/mainquest/show_secondary_objective
