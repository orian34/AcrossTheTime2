...
##no bug!
execute in minecraft:overworld positioned -3788 70 -5876 unless entity @e[type=minecraft:villager,distance=..5] run function att2:cinematic/sidequest/26/emerald/summon_pnj
