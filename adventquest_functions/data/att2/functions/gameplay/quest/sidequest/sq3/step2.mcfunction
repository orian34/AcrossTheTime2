#####################################################################
#Made by Adventquest											    #
#Display text and physical help for SQ3 SIDEQUEST matches 2        	#
#####################################################################
...
execute in minecraft:overworld positioned -4694 42 -5121 run function att2:gameplay/quest/mainquest/show_secondary_objective