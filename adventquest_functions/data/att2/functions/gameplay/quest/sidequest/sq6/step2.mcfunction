...
execute in minecraft:overworld if data block -5058 71 -5063 {LootTable:"att2:chest/reg1/c5t5_hurrielkey"} positioned -5058 71 -5063 run function att2:gameplay/quest/mainquest/show_secondary_objective