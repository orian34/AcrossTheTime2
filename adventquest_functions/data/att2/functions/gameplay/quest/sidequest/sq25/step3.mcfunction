...
##no bug!
execute in minecraft:overworld positioned -4005 80 -5576 unless entity @e[type=minecraft:villager,distance=..5] run function att2:cinematic/sidequest/25/emerald/summon_pnj
