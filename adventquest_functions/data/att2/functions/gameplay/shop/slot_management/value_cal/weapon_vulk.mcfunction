...
execute if score heros REPUTATION matches 40.. if score @s SHOP_OP1 matches ..239 store result score @s SHOP_OP1 run random value 0..614
execute if score heros REPUTATION matches 80.. if score @s SHOP_OP1 matches 240..614 store result score @s SHOP_OP1 run random value 240..899
execute if score heros REPUTATION matches 120.. if score @s SHOP_OP1 matches 615..899 store result score @s SHOP_OP1 run random value 615..979
execute if score heros REPUTATION matches 160.. if score @s SHOP_OP1 matches 900..979 store result score @s SHOP_OP1 run random value 900..999

execute if score heros REPUTATION matches 200.. if score @s SHOP_OP1 matches ..239 store result score @s SHOP_OP1 run random value 0..614
execute if score heros REPUTATION matches 240.. if score @s SHOP_OP1 matches 240..614 store result score @s SHOP_OP1 run random value 240..899
execute if score heros REPUTATION matches 280.. if score @s SHOP_OP1 matches 615..899 store result score @s SHOP_OP1 run random value 615..979
execute if score heros REPUTATION matches 320.. if score @s SHOP_OP1 matches 900..979 store result score @s SHOP_OP1 run random value 900..999
#shop tips
