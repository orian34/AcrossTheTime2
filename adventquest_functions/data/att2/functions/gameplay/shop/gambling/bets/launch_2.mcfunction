...
execute positioned -4961 97 -5802 run summon minecraft:experience_orb ~ ~0.5 ~ {Value:25}
execute positioned -4961 97 -5802 run summon minecraft:experience_orb ~ ~1 ~ {Value:50}
execute positioned -4961 97 -5802 run summon minecraft:experience_orb ~ ~2 ~ {Value:100}