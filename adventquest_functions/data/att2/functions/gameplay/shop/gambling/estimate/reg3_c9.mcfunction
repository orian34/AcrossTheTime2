...
execute positioned -4961 97 -5802 run function att2:summon/gambling_reg3_9
...
kill @e[type=item,distance=..3,nbt={Item:{tag:{Rarity:"reg3_c9"}}},limit=1]
scoreboard players remove reg3_c9 GAMBLING 1