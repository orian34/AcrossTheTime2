...
execute positioned -4961 97 -5802 run function att2:summon/bat_boss_esc_rewards
execute positioned -4961 97 -5802 run function att2:summon/gambling12
...
kill @e[type=item,distance=..2,nbt={Item:{tag:{Rarity:"c12"}}},limit=1]
scoreboard players remove c12 GAMBLING 1