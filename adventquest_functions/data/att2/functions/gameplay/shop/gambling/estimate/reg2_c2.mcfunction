...
execute positioned -4961 97 -5802 run function att2:summon/gambling_reg2_2
...
kill @e[type=item,distance=..3,nbt={Item:{tag:{Rarity:"reg2_c2"}}},limit=1]
scoreboard players remove reg2_c2 GAMBLING 1