...
execute positioned -4961 97 -5802 run function att2:summon/gambling_reg2_5
...
kill @e[type=item,distance=..3,nbt={Item:{tag:{Rarity:"reg2_c5"}}},limit=1]
scoreboard players remove reg2_c5 GAMBLING 1