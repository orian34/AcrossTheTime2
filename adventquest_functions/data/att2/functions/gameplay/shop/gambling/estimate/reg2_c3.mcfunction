...
execute positioned -4961 97 -5802 run function att2:summon/gambling_reg2_3
...
kill @e[type=item,distance=..3,nbt={Item:{tag:{Rarity:"reg2_c3"}}},limit=1]
scoreboard players remove reg2_c3 GAMBLING 1