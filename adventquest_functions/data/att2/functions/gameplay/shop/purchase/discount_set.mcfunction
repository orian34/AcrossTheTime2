...
execute if score heros REPUTATION matches ..0 run function att2:gameplay/shop/purchase/discount0
execute if score heros REPUTATION matches 1..100 run function att2:gameplay/shop/purchase/discount1
...
execute if score discount discount_calc matches ..65 run scoreboard players set discount discount_calc 70
