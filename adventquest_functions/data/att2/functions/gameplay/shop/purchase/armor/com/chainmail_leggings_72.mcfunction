...
execute if score @s CHRONOTON >= armor72 PRICES run function att2:items/armor/com/chainmail_leggings_72 
execute if score @s CHRONOTON >= armor72 PRICES run scoreboard players operation @s CHRONOTON -= armor72 PRICES
