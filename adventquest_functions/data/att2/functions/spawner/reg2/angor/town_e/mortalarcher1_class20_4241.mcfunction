####################################	*#
#Spawner for att2:summon/reg_2/mortalarcher1_class20	#
####################################	*#
...
execute positioned 3748 39 4327 unless entity @e[team=hostile,distance=..15,scores={COUNT=5..}] run function att2:summon/reg_2/mortalarcher1_class20
