...
execute positioned -4930 61 -5626 as @e[team=ally,distance=..20,limit=1] run scoreboard players set @s COUNT 0
...
execute positioned -4930 61 -5626 as @e[team=ally,distance=..20,scores={COUNT=0..}] run scoreboard players reset @s COUNT
