...
##revoke test
advancement revoke @s only att2_test:test_mobskilled/wolf
...
# WOLF
advancement grant @s[scores={statWOLFKILLED=10..}] only att2:mobskilled/wolfs_killed_10
advancement grant @s[scores={statWOLFKILLED=50..}] only att2:mobskilled/wolfs_killed_50
advancement grant @s[scores={statWOLFKILLED=250..}] only att2:mobskilled/wolfs_killed_250
advancement grant @s[scores={statWOLFKILLED=500..}] only att2:mobskilled/wolfs_killed_500
