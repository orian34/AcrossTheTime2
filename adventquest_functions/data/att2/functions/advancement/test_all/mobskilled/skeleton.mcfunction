...
##revoke test
advancement revoke @s only att2_test:test_mobskilled/skeleton
scoreboard players operation @s statSKELETKILLED += @s statSKELETKILLED1
scoreboard players set @s statSKELETKILLED1 0
# TOTAL KILLED
...
# SKELETONS
advancement grant @s[scores={statSKELETKILLED=10..}] only att2:mobskilled/skeletons_killed_10
advancement grant @s[scores={statSKELETKILLED=50..}] only att2:mobskilled/skeletons_killed_50
advancement grant @s[scores={statSKELETKILLED=250..}] only att2:mobskilled/skeletons_killed_250
advancement grant @s[scores={statSKELETKILLED=500..}] only att2:mobskilled/skeletons_killed_500
