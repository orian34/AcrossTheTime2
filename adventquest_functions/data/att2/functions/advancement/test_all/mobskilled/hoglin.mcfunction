...
##revoke test
advancement revoke @s only att2_test:test_mobskilled/hoglin
...
# HOGLIN
advancement grant @s[scores={statHOGLINKILLED=5..}] only att2:mobskilled/hoglins_killed_5
advancement grant @s[scores={statHOGLINKILLED=25..}] only att2:mobskilled/hoglins_killed_25
advancement grant @s[scores={statHOGLINKILLED=100..}] only att2:mobskilled/hoglins_killed_100
advancement grant @s[scores={statHOGLINKILLED=250..}] only att2:mobskilled/hoglins_killed_250
