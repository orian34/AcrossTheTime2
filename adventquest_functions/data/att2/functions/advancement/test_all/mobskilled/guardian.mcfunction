...
##revoke test
advancement revoke @s only att2_test:test_mobskilled/guardian
...
# GUARDIAN
advancement grant @s[scores={statGUARDKILLED=5..}] only att2:mobskilled/guardians_killed_5
advancement grant @s[scores={statGUARDKILLED=25..}] only att2:mobskilled/guardians_killed_25
advancement grant @s[scores={statGUARDKILLED=100..}] only att2:mobskilled/guardians_killed_100
advancement grant @s[scores={statGUARDKILLED=250..}] only att2:mobskilled/guardians_killed_250
