...
##revoke test
advancement revoke @s only att2_test:test_mobskilled/husk
...
# HUSK
advancement grant @s[scores={statHUSKKILLED=10..}] only att2:mobskilled/husks_killed_10
advancement grant @s[scores={statHUSKKILLED=50..}] only att2:mobskilled/husks_killed_50
advancement grant @s[scores={statHUSKKILLED=250..}] only att2:mobskilled/husks_killed_250
advancement grant @s[scores={statHUSKKILLED=500..}] only att2:mobskilled/husks_killed_500
