...
# MAGMA
advancement grant @s[scores={statLAVASKILLED=10..}] only att2:mobskilled/lavaslimes_killed_10
advancement grant @s[scores={statLAVASKILLED=50..}] only att2:mobskilled/lavaslimes_killed_50
advancement grant @s[scores={statLAVASKILLED=250..}] only att2:mobskilled/lavaslimes_killed_250
advancement grant @s[scores={statLAVASKILLED=500..}] only att2:mobskilled/lavaslimes_killed_500
