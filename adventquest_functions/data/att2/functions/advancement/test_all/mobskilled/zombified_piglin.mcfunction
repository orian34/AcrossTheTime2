...
##revoke test
advancement revoke @s only att2_test:test_mobskilled/zombified_piglin
...
# HUMANOIDS
advancement grant @s[scores={statPIGMANKILLED=10..}] only att2:mobskilled/humanoids_killed_10
advancement grant @s[scores={statPIGMANKILLED=50..}] only att2:mobskilled/humanoids_killed_50
advancement grant @s[scores={statPIGMANKILLED=250..}] only att2:mobskilled/humanoids_killed_250
advancement grant @s[scores={statPIGMANKILLED=500..}] only att2:mobskilled/humanoids_killed_500
