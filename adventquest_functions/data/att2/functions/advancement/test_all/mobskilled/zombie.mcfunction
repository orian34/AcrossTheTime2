...
##revoke test
advancement revoke @s only att2_test:test_mobskilled/zombie
...
# ZOMBIES
advancement grant @s[scores={statZOMBIEKILLED=10..}] only att2:mobskilled/zombies_killed_10
advancement grant @s[scores={statZOMBIEKILLED=50..}] only att2:mobskilled/zombies_killed_50
advancement grant @s[scores={statZOMBIEKILLED=250..}] only att2:mobskilled/zombies_killed_250
advancement grant @s[scores={statZOMBIEKILLED=500..}] only att2:mobskilled/zombies_killed_500
