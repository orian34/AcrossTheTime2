...
##revoke test
advancement revoke @s only att2_test:test_mobskilled/vex
...
# VEX
advancement grant @s[scores={statVEXKILLED=5..}] only att2:mobskilled/vex_killed_5
advancement grant @s[scores={statVEXKILLED=25..}] only att2:mobskilled/vex_killed_25
advancement grant @s[scores={statVEXKILLED=100..}] only att2:mobskilled/vex_killed_100
advancement grant @s[scores={statVEXKILLED=250..}] only att2:mobskilled/vex_killed_250
