...
##revoke test
advancement revoke @s only att2_test:test_mobskilled/ghast
...
execute if score Mainquest SIDEQUEST matches 182.. run advancement grant @s[scores={statGHASTKILLED=1..}] only att2:mobskilled/ghasts_killed_1
execute if score Mainquest SIDEQUEST matches 182.. run advancement grant @s[scores={statGHASTKILLED=5..}] only att2:mobskilled/ghasts_killed_5
execute if score Mainquest SIDEQUEST matches 182.. run advancement grant @s[scores={statGHASTKILLED=25..}] only att2:mobskilled/ghasts_killed_25
execute if score Mainquest SIDEQUEST matches 182.. run advancement grant @s[scores={statGHASTKILLED=100..}] only att2:mobskilled/ghasts_killed_100
