...
# SPIDER
advancement grant @s[scores={statSPIDERKILLED=10..}] only att2:mobskilled/spiders_killed_10
advancement grant @s[scores={statSPIDERKILLED=50..}] only att2:mobskilled/spiders_killed_50
advancement grant @s[scores={statSPIDERKILLED=250..}] only att2:mobskilled/spiders_killed_250
advancement grant @s[scores={statSPIDERKILLED=500..}] only att2:mobskilled/spiders_killed_500
