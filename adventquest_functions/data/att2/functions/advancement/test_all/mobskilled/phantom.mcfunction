...
##revoke test
advancement revoke @s only att2_test:test_mobskilled/phantom
...
# PHANTOM
advancement grant @s[scores={statPHANTOKILLED=5..}] only att2:mobskilled/phantoms_killed_5
advancement grant @s[scores={statPHANTOKILLED=25..}] only att2:mobskilled/phantoms_killed_25
advancement grant @s[scores={statPHANTOKILLED=100..}] only att2:mobskilled/phantoms_killed_100
advancement grant @s[scores={statPHANTOKILLED=250..}] only att2:mobskilled/phantoms_killed_250
