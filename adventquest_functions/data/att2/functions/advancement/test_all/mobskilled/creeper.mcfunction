...
##revoke test
advancement revoke @s only att2_test:test_mobskilled/creeper
...
# CREEPERS
advancement grant @s[scores={statCREEPKILLED=5..}] only att2:mobskilled/creepers_killed_5
advancement grant @s[scores={statCREEPKILLED=25..}] only att2:mobskilled/creepers_killed_25
advancement grant @s[scores={statCREEPKILLED=100..}] only att2:mobskilled/creepers_killed_100
advancement grant @s[scores={statCREEPKILLED=250..}] only att2:mobskilled/creepers_killed_250
