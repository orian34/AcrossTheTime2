...
##revoke test
advancement revoke @s only att2_test:test_mobskilled/pillager
...
# PILLAGER
advancement grant @s[scores={statPILLAKILLED=10..}] only att2:mobskilled/pillagers_killed_10
advancement grant @s[scores={statPILLAKILLED=50..}] only att2:mobskilled/pillagers_killed_50
advancement grant @s[scores={statPILLAKILLED=250..}] only att2:mobskilled/pillagers_killed_250
advancement grant @s[scores={statPILLAKILLED=500..}] only att2:mobskilled/pillagers_killed_500
