...
##revoke test
advancement revoke @s only att2_test:test_mobskilled/slime
...
# SLIMES
advancement grant @s[scores={statSLIMEKILLED=10..}] only att2:mobskilled/slimes_killed_10
advancement grant @s[scores={statSLIMEKILLED=50..}] only att2:mobskilled/slimes_killed_50
advancement grant @s[scores={statSLIMEKILLED=250..}] only att2:mobskilled/slimes_killed_250
advancement grant @s[scores={statSLIMEKILLED=500..}] only att2:mobskilled/slimes_killed_500
