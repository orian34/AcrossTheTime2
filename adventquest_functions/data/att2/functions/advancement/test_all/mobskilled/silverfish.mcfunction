...
##revoke test
advancement revoke @s only att2_test:test_mobskilled/silverfish
...
# SILVERFISH
advancement grant @s[scores={statSILVERKILLED=10..}] only att2:mobskilled/silverfish_killed_10
advancement grant @s[scores={statSILVERKILLED=50..}] only att2:mobskilled/silverfish_killed_50
advancement grant @s[scores={statSILVERKILLED=250..}] only att2:mobskilled/silverfish_killed_250
advancement grant @s[scores={statSILVERKILLED=500..}] only att2:mobskilled/silverfish_killed_500
